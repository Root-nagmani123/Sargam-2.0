...
/**
 * Peer Evaluation -> Manage Events -> .xlsx
 *
 * Columns arrive already resolved by PeerEventController::resolveExportColumns(),
 ...
 */
class PeerEventExport implements
    FromArray,
    WithHeadings,
    ShouldAutoSize,
    WithEvents,
    ...
    WithCustomStartCell
{
    ...
    private const CENTRED = ['sno', 'created_date', 'start_date', 'end_date'];
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A2', 'MANAGE EVENTS');
