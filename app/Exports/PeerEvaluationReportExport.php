...
/**
 * Peer Evaluation -> Evaluation Reports -> .xlsx
 *
 * Columns arrive already resolved by PeerEvaluationReportController::resolveExportColumns(),
 ...
 */
class PeerEvaluationReportExport implements
    FromArray,
    WithHeadings,
    ShouldAutoSize,
    WithEvents,
    ...
    WithCustomStartCell
{
    ...
    private const CENTRED = ['sno', 'evaluators', 'status', 'overall'];
    ...
    public function title(): string
    {
        ...
        $name = $this->reportTitle ?: 'Evaluation Reports';
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A2', mb_strtoupper($this->reportTitle ?: 'Evaluation Reports'));
