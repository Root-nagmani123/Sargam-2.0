...
/**
 * Branded .xlsx for the HAC Approval queue.
 *
 * The Print view (admin/estate/change_request_hac_approved_print.blade.php)
 ...
 */
class EstateHacApprovedExport implements
    FromArray,
    WithHeadings,
    ShouldAutoSize,
    WithStyles,
    ...
    WithCustomStartCell
{
    ...
    public static function columnDefs(): array
    {
        return [
            ...
            'request_type' => [
                ...
                'center' => true,
                'width' => 14,
                'value' => fn ($row) => EstateHacApprovedDataTable::requestTypeLabel($row),
            ],
            'request_id' => [
                'heading' => 'Request ID',
                'center' => false,
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        if ($lastRow >= $firstDataRow) {
            ...
            // Zebra striping + the request-type cell tinted like its on-screen pill.
            $typeCol = $this->colLetter('request_type');
            $row = $firstDataRow;
            foreach ($this->rows as $record) {
                ...
                if ($typeCol !== null) {
                    [$bg, $fg] = EstateHacApprovedDataTable::requestTypeLabel($record) === 'Change Request'
                        ? ['FFFAEB', 'B54708']
                        : ['EFF8FF', '175CD3'];
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A2', 'HAC APPROVAL');
