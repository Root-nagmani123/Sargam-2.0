...
class LeaveApprovalExport implements FromCollection, WithEvents
{
    ...
    public function __construct(
        ...
        protected FacultyLeaveApprovalService $approvalService,
        protected string $filterLine = '',
        protected string $approverLine = ''
    ) {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $metaLines[] = ['text' => 'Leave Approval Report', 'style' => 'title'];

                if ($this->approverLine !== '') {
                    $metaLines[] = ['text' => $this->approverLine, 'style' => 'approver'];
                }
                ...
                $widths = [10, 12, 22, 14, 12, 12, 10, 30, 12, 20];
