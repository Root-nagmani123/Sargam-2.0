...
/**
 * Peer Evaluation -> Manage Reflection Fields -> .xlsx
 *
 * Columns arrive already resolved by PeerReflectionFieldController::resolveExportColumns(),
 ...
 */
class PeerReflectionFieldExport implements
    FromArray,
    WithHeadings,
    ShouldAutoSize,
    WithEvents,
    ...
    WithCustomStartCell
{
    ...
    private const CENTRED = ['sno', 'created_date', 'status'];
    ...
    {
        return 'Manage Reflection Fields';
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A2', 'MANAGE REFLECTION FIELDS');
                ...
                foreach ($this->columns as $key => $col) {
                    if (in_array($key, self::CENTRED, true)) {
