 ...
 * IssueEscalationMatrixController::resolveExportColumns(), which is the same array the
 ...
 */
class IssueEscalationMatrixExport implements
    FromArray,
    WithHeadings,
    ShouldAutoSize,
    WithEvents,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A2', 'ESCALATION MATRIX');
