...
/**
 * Manage Priorities → .xlsx
 *
 * Columns are handed in already resolved by
 * IssuePriorityController::resolveExportColumns(), which is the same array the
 ...
 */
class IssuePriorityExport implements
    FromArray,
    WithHeadings,
    ShouldAutoSize,
    WithEvents,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A2', 'MANAGE PRIORITIES');
