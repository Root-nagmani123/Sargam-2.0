...
trait ExportsBrandedGrid
{
     ...
     * @param  string  $title     report name, e.g. "Course Master"
     * @param  string  $fileBase  filename stem -> CourseMaster_20260816102233.csv
     * @param  array<string, array{heading:string, class:string, value:callable}>  $columns
     * @param  array{columnStyles?:string, emptyText?:string, centeredKeys?:list<string>, textKeys?:list<string>, orientation?:string}  $options
     */
