...
use App\DataTables\IssueSubCategoryDataTable;
...
class IssueSubCategoryController extends Controller
{
     ...
     */
    public function index(IssueSubCategoryDataTable $dataTable)
    {
        $categories = IssueCategoryMaster::active()->orderBy('issue_category')->get();

        return $dataTable->render('admin.issue_management.sub_categories.index', compact('categories'));
    }
