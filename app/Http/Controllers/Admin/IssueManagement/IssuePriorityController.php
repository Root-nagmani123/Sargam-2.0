...
use App\DataTables\IssuePriorityDataTable;
...
class IssuePriorityController extends Controller
{
     ...
     */
    public function index(IssuePriorityDataTable $dataTable)
    {
        return $dataTable->render('admin.issue_management.priorities.index');
    }
