...
class MDODutyTypeMasterDataTable extends DataTable
{
    ...
    {
        return [
            Column::computed('DT_RowIndex')->title('S.No.')->orderable(true)->searchable(false),
            Column::make('mdo_duty_type_name')->title('Duty Type Name')->orderable(true)->searchable(true),
