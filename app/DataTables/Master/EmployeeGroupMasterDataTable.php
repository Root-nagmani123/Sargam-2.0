...
class EmployeeGroupMasterDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            // box / pagination / count into the #egmDtSearch and #egmDtFooter
            // slots declared in admin/master/employee_group/index.blade.php.
            ->selectStyleSingle()
            ...
            ->parameters([
                ...
                'language' => [
                    ...
                    'emptyTable' => 'No employee groups found.',
                    'zeroRecords' => 'No matching employee groups found.',
    ...
    public function getColumns(): array
    {
        ...
        return [
            ...
            Column::make('emp_group_name')->title('Employee Group Name')->orderable(false)->addClass('text-start'),
