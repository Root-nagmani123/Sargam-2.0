...
class HostelFloorMasterDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->filterColumn('hostel_floor_name', function ($query, $keyword) {
                $query->where('hostel_floor_name', 'like', "%{$keyword}%");
            })
            ->rawColumns(['hostel_floor_name', 'action', 'status']);
    }
     ...
     */
    public function query(HostelFloorMaster $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('hostel_floor_name')->title('Hostel Floor Name')->orderable(false)->addClass('text-center'),
