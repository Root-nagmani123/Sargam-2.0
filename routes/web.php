...
Route::prefix('admin/mess')->name('admin.mess.')->middleware(['auth'])->group(function () {
    ...
    Route::get('storeallocations/export', [\App\Http\Controllers\Mess\StoreAllocationController::class, 'export'])->name('storeallocations.export');
    ...
    Route::get('selling-voucher-date-range/export', [\App\Http\Controllers\Mess\SellingVoucherDateRangeController::class, 'export'])->name('selling-voucher-date-range.export');
