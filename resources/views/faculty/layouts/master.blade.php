...
<body data-sidebartype="mini-sidebar">
    {{-- Preloader — shared with admin/layouts/master, styles + hide logic included.
         Replaces the old #alphabetLoader, which had no hide logic anywhere and so
         never went away once painted. --}}
            ...
            .then(function (data) {
                ...
                if (count > 0) {
                    ...
                    (data.items || []).slice(0, 5).forEach(function (item) {
                        ...
                        li.innerHTML =
                            '<a href="' + feedbackUrl + '" class="d-block px-3 py-2 text-decoration-none text-dark">' +
