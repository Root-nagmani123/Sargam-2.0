...
<head>
    <meta charset="utf-8">
    <title>Revised Time Table Week {{ (int) ($sheetWeekNumber ?? $weekNum) }} — {{ Str::limit($courseProgrammeTitle ?? $courseTitle ?? 'Timetable', 48) }}</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        table.grid thead tr.day-names th {
