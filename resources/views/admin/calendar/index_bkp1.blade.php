            ...
            <form id="eventForm">
                ...
                <div class="modal-content">
                                ...
                                <div class="d-flex">
                                    <div class="n-chk">
                                        <div class="form-check form-check-primary form-check-inline">
                                            ...
                                            <label class="form-check-label"
                                                for="modalDanger-{{ uniqid() }}">Lecture</label>
                                        </div>
                                    </div>
                                    <div class="n-chk">
                                    ...
                                    <div class="n-chk">
                                        <div class="form-check form-check-danger form-check-inline">
                                            ...
                                            <label class="form-check-label"
                                                for="modalWarning-{{ uniqid() }}">Module</label>
                                        </div>
                                    </div>
                                    <div class="n-chk">
                                        <div class="form-check form-check-danger form-check-inline">
                                    ...
                                    <label class="form-label">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                name="feedback_checkbox" id="feedback_checkbox">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary btn-add-event" style="display: none;">
                            Add Calendar Event
                        </button>
                    </div>
                </div>
