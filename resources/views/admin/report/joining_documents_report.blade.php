...
<div class="container-fluid mt-4">
    <x-breadcrum title="Joining Documents Report" />
        <x-session_message />
    {{-- Table Section --}}
    <div class="card" style="border-left: 4px solid #004a93;">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped align-middle text-center table-hover table-sm mb-0 text-nowrap">
