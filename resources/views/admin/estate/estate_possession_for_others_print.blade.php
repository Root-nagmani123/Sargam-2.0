@php
    ...
    $defs = EstatePossessionOtherExport::columnDefs();
...
<head>
    ...
    <title>Estate Possession for Others - LBSNAA MUSSOORIE</title>
    <style>
...
<body>
    ...
    <div class="report-title-block">
        <h1 class="report-title">Estate Possession for Others</h1>
