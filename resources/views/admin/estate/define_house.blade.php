...
$(document).ready(function() {
    ...
    function buildDefineHouseColumnToggle() {
        ...
        table.columns().every(function(i) {
            ...
            var $li = $('<li><label class="dropdown-item d-flex align-items-center gap-1 cursor-pointer mb-0"><input type="checkbox" class="form-check-input column-toggle-define-house" data-column="' + i + '"> ' + header + '</label></li>');
