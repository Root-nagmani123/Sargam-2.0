{{--
    Change Request For House — print view.

    Rendered by EstateController@printRequestForHouse from the SAME payload as the
    Excel download (exportPayload), and the columns come from
    EstateChangeRequestHouseExport::columnDefs(), so the printout and the .xlsx cannot
...
@php
    ...
    $defs = EstateChangeRequestHouseExport::columnDefs();
...
<head>
    ...
    <title>Change Request For House</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 12mm;
...
<body onload="window.print()">
    <div class="rpt-header">
        ...
        <div class="rpt-title">Change Request For House</div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td class="rpt-empty" colspan="{{ max(1, count($cols)) }}">No change requests match this search.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
