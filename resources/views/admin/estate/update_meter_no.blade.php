...
$(document).ready(function() {
    ...
    function buildUpdateMeterNoColumnToggle() {
        ...
        table.columns().every(function(i) {
            ...
            if (!header) return;
            var $li = $('<li><label class="dropdown-item d-flex align-items-center gap-1 cursor-pointer mb-0"><input type="checkbox" class="form-check-input column-toggle-update-meter-no" data-column="' + i + '"> ' + header + '</label></li>');
