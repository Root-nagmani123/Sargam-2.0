@php
    ...
    $defs = EstateUpdateMeterNoExport::columnDefs();
...
<head>
    ...
    <title>Update Meter Details - LBSNAA MUSSOORIE</title>
    <style>
...
<body>
    ...
    <div class="report-title-block">
        <h1 class="report-title">Update Meter Details</h1>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr class="empty-row">
                    <td colspan="{{ $colCount }}">No meter records found for the applied filters.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
