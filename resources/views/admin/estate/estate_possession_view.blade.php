        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.estate.possession-view.store') }}" id="possessionForm">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <label for="house_no" class="form-label">House No. (Backup)</label>
                        <input type="text" class="form-control" id="house_no" name="house_no" placeholder="Auto-filled from selection" value="{{ old('house_no', isset($record) ? $record->house_no : '') }}">
                        <small class="text-muted">Stored for display</small>
                    </div>
                </div>
