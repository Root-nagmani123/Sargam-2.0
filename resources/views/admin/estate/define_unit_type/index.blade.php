...
$(document).ready(function() {
    ...
    var $addBtn = $('.unit-type-add-btn');
    var $filter = $('[data-sargam-dt-filter="unitTypeTable"]').first();
    if (!$filter.length) {
        $filter = $('#unitTypeTable').closest('.dataTables_wrapper').find('.dataTables_filter').first();
    }
