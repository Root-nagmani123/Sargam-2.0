@php
    ...
    $defs = EstateRequestForEstateExport::columnDefs();
...
<head>
    ...
    <title>Request For Estate - LBSNAA MUSSOORIE</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .status--allotted { color: #027a48; }
        .status--pending { color: #b54708; }
        .status--returned { color: #175cd3; }
...
<body>
    ...
    <div class="report-title-block">
        <h1 class="report-title">Request For Estate</h1>
    ...
    <table class="data-table">
        ...
        <tbody>
                    ...
                    @foreach($columns as $column)
                        ...
                        <td class="{{ $column['center'] ? 'text-center' : '' }}">
                            @if($column['key'] === 'status')
                                <span class="status status--{{ strtolower($value) }}">{{ $value }}</span>
                            @else
            ...
            @empty
                <tr class="empty-row">
                    <td colspan="{{ $colCount }}">No estate requests found for the applied filters.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
