{{--
    Return House — print view.

    Rendered by EstateController@printReturnHouse from the SAME payload as the
    Excel download (exportPayload), and the columns come from
    EstateReturnHouseExport::columnDefs(), so the printout and the .xlsx cannot
...
@php
    ...
    $defs = EstateReturnHouseExport::columnDefs();
...
<body onload="window.print()">
    <div class="rpt-header">
        ...
        <div class="rpt-title">Return House</div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td class="rpt-empty" colspan="{{ max(1, count($cols)) }}">No returned houses match this search.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
