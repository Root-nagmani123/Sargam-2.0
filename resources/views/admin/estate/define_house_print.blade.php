{{--
    Define House — print view.

    Rendered by EstateController@printDefineHouse from the SAME payload as the
    Excel download (defineHouseExportPayload), and the columns come from
    EstateDefineHouseExport::columnDefs(), so the printout and the .xlsx cannot
...
@php
    ...
    $defs = EstateDefineHouseExport::columnDefs();
...
<body onload="window.print()">
    <div class="rpt-header">
        ...
        <div class="rpt-title">Define House</div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td class="rpt-empty" colspan="{{ max(1, count($cols)) }}">No houses match this search.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
