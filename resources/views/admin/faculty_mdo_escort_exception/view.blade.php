...
<div class="container-fluid">
    <div class="card" style="border-left:4px solid #004a93;">
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-6">
                    <h4>Faculty MDO/Escort Exception View</h4>
                </div>
                <div class="col-6">
                        ...
                        <div class="student-card">
                            <div class="student-header">
                                ...
                                <div class="exemption-count-badge">
                                    <i class="material-icons menu-icon material-symbols-rounded" style="font-size: 20px; vertical-align: middle;">assignment</i>
                                    Total Exceptions: {{ $student['total_exception_count'] }}
                                </div>
                            </div>
                                        ...
                                        <div class="exemption-item">
                                            <div class="exemption-details">
                                                <div class="detail-item">
                                                    ...
                                                    <span class="detail-value">{{ $exemption['faculty'] ?? 'N/A' }}</span>
                                                </div>
                                                <div class="detail-item">
                                                    <span class="detail-label">Date:</span>
                                                    <span class="detail-value">{{ $exemption['date'] ? \Carbon\Carbon::parse($exemption['date'])->format('d/m/Y') : 'N/A' }}</span>
                                                </div>
                                                <div class="detail-item">
                                                ...
                                                <div class="detail-item">
                                                    ...
                                                    <span class="detail-value">{{ $student['student_name'] ?? 'N/A' }}</span>
                                                </div>
                                                <div class="detail-item">
                                                    <span class="detail-label">Duty Type:</span>
                                                    <span class="detail-value">{{ $exemption['duty_type'] ?? 'N/A' }}</span>
                                                </div>
                                                <div class="detail-item">
                                                    <span class="detail-label">Time:</span>
                                                    <span class="detail-value">{{ $exemption['time'] ?? 'N/A' }}</span>
                                                </div>
                                                @if($exemption['description'] && $exemption['description'] !== 'N/A')
                            ...
                            @foreach($faculty['courses'] as $course)
                                <div class="course-card">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        ...
                                        <div class="text-end">
                                            <div class="exemption-count-badge">
                                                <i class="material-icons menu-icon material-symbols-rounded" style="font-size: 18px; vertical-align: middle;">assignment</i>
