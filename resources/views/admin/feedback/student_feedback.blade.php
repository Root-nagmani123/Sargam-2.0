...
<body style="min-height: 100vh; display: flex; flex-direction: column;">
   ...
   <div class="top-header d-flex justify-content-between align-items-center d-none d-md-block py-2" style="background-color: #004a93;">
       <div class="container">
           <div class="row">
               ...
               <div class="col-md-9 text-end d-flex justify-content-end align-items-center">
                   <ul class="nav justify-content-end align-items-center">
                       ...
                       <li class="nav-item"><a class="text-decoration-none" id="uw-widget-custom-trigger" contenteditable="false" style="cursor: pointer;"><img
               ...
               <div class="container-fluid px-0">
                   ...
                   <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                       <ul class="navbar-nav align-items-center">
                           <li class="nav-item">
                               <a class="nav-link ms-4 me-4" href="https://www.lbsnaa.gov.in/menu/about-lbsnaa" target="_blank">About Us</a>
                           </li>
                           <li class="nav-item">
                               <a class="nav-link ms-4 me-4" href="https://www.lbsnaa.gov.in/footer_menu/contact-us" target="_blank">Contact</a>
                           </li>
                       </ul>
                   </div>
               </div>
