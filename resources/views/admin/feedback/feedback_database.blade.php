...
@section('setup_content')
    ...
    <div class="container-fluid">
        ...
        <div class="card filter-card mb-4">
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-3 col-md-4 dynamic-filter-container hidden" id="facultyFilterContainer">
                    ...
                    <div class="col-lg-3 col-md-4 dynamic-filter-container hidden" id="topicFilterContainer">
        ...
        <!-- PAGINATION -->
        <div class="d-flex justify-content-between align-items-center mt-4" id="paginationSection" style="display: none;">
...
@section('scripts')
        ...
        $(document).ready(function() {
            ...
            function initializeEventListeners() {
                ...
                safeBind('#searchParam', 'change', function(e) {
                    ...
                    $('.dynamic-filter-container').addClass('hidden').removeClass('visible');
   ...
   title="View faculty details">
    ...
    doc.text('Feedback Database Report', pageWidth / 2, 15, { align: 'center' });
