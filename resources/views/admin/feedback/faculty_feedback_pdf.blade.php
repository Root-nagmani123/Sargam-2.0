    ...
    {{-- <div class="filters-section">
        ...
        <div class="filter-row">
            ...
            <div class="filter-item">
                ...
                <span class="filter-value">{{ $feedbackData->count() }}</span>
            </div>
        </div>
    </div> --}}
                ...
                <div class="meta-info">
                    ...
                    @if (!empty($data['Lecture Date']))
                        <p class="mb-0">
                            ...
                            @if (!empty($data['Start Time']) && !empty($data['End Time']))
                ...
                <table class="feedback-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data['Content - Excellent'] }}</td>
                            <td>{{ $data['Presentation - Excellent'] }}</td>
                        </tr>
                        <!-- Very Good -->
                        <tr>
                            <th class="rating-header">Very Good</th>
                            <td>{{ $data['Content - Very Good'] }}</td>
                            <td>{{ $data['Presentation - Very Good'] }}</td>
                        </tr>
                        <!-- Good -->
                        <tr>
                            <th class="rating-header">Good</th>
                            <td>{{ $data['Content - Good'] }}</td>
                            <td>{{ $data['Presentation - Good'] }}</td>
                        </tr>
                        <!-- Average -->
                        <tr>
                            <th class="rating-header">Average</th>
                            <td>{{ $data['Content - Average'] }}</td>
                            <td>{{ $data['Presentation - Average'] }}</td>
                        </tr>
                        <!-- Below Average -->
                        <tr>
                            <th class="rating-header">Below Average</th>
                            <td>{{ $data['Content - Below Average'] }}</td>
                            <td>{{ $data['Presentation - Below Average'] }}</td>
                        </tr>
                        <!-- Percentage -->
                        <tr style="font-weight: 600;">
                            <th class="rating-header">Percentage</th>
                            <td class="percentage-cell">{{ $data['Content Percentage'] }}</td>
                            <td class="percentage-cell">{{ $data['Presentation Percentage'] }}</td>
                        </tr>
                    </tbody>
                </table>
                <div class="total-info">* is defined as Total Student Count: {{ $data['Total Participants'] }}</div>
