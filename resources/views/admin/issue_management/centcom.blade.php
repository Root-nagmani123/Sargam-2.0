            ...
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-6 text-end">
                        <a href="{{ route('admin.issue-management.create') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-4 col-lg-2">
                            ...
                            <select name="category" class="form-select form-select-sm">
                                ...
                                <option value="{{ $category->pk }}"
                                    {{ request('category') == $category->pk ? 'selected' : '' }}>
                        ...
                        <div class="col-12 col-md-4 col-lg-2">
                            ...
                            <select name="priority" class="form-select form-select-sm">
                                ...
                                <option value="{{ $p->pk }}" {{ request('priority') == $p->pk ? 'selected' : '' }}>
                                    {{ $p->priority ?? 'N/A' }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-12 col-md-4 col-lg-2">
                        ...
                        <div class="col-12 col-lg-2 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('admin.issue-management.centcom') }}"
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge bg-{{ $issue->issue_status == 2 ? 'success' : ($issue->issue_status == 1 ? 'info' : ($issue->issue_status == 6 ? 'warning' : 'secondary')) }}">
                                        {{ $issue->status_label }}
                                    </span>
                                </td>
