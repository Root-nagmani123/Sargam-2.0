...
<body>
    ...
    <div class="report-title">ESCALATION MATRIX</div>
    <div class="meta">
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="{{ count($columns) }}" class="empty">No escalation mappings to export</td></tr>
            @endforelse
        </tbody>
    </table>
