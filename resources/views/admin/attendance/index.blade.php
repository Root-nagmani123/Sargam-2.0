...
<div class="container-fluid attendance-master-page py-3 px-3 px-lg-4">
    ...
    <div class="card attendance-dt-card overflow-hidden">
            ...
            <div class="d-flex flex-column flex-xl-row align-items-xl-center justify-content-between gap-3 mb-4 programme-dt-toolbar attendance-dt-toolbar w-100">
                <div class="d-flex flex-wrap align-items-center gap-3">
                    ...
                    <div class="visually-hidden" aria-hidden="true">
                        <input class="form-check-input" type="radio" name="attendance_type" id="full_day" value="full_day">
                        <input class="form-check-input" type="radio" name="attendance_type" id="manual" value="manual" checked>
  ...
  window.attTimePeriodPicker = null;
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#resetAttendance', function () {
            setTimeout(function () {
                syncAttendanceTypeUi();
                $('#attendance_type_ui').val('manual').trigger('change');
                var t = new Date();
                var ts = formatYmd(t);
                $('#from_date').val(ts);
                $('#to_date').val(ts);
