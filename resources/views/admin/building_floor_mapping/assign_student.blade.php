...
@section('setup_content')
    <div class="container-fluid hostel-assign-index">
            ...
            <div class="card" style="border-left: 4px solid #004a93;">
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="row align-items-center mb-3 hostel-assign-header-row">
                            <div class="col-12 col-md-6">
                                <h4 class="fw-semibold mb-2 mb-md-0">Hostel Building Assign Student</h4>
                            </div>
                            <div class="col-12 col-md-6 d-flex justify-content-md-end gap-2 flex-wrap hostel-assign-actions">
                                {{-- <button type="button" class="btn btn-success d-flex align-items-center"
                                    data-bs-toggle="modal" data-bs-target="#importModal">
                                    <iconify-icon icon="mdi:file-excel" width="1.2em" height="1.2em"
                                        class="me-1"></iconify-icon> Import Excel
                                </button> --}}
                                <a href="{{ route('hostel.building.map.import') }}"
