...
<div class="container-fluid">
    <x-breadcrum :title="'Faculty Notice / Memo View'" />
    <x-session_message />
    <div class="row mb-3">
        <div class="col-12 text-end">
            <div class="d-flex justify-content-end align-items-center gap-2">
                <button type="button" class="btn btn-primary d-flex align-items-center border-0 bg-white text-primary" onclick="window.print()" >
                    <i class="material-icons menu-icon material-symbols-rounded me-2" style="font-size: 24px;">print</i>
                    Download / Print
                </button>
            </div>
        </div>
                    ...
                    <div class="card bg-light">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label fw-bold text-muted mb-1">Total Number of
                                            Notice/Memo</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label fw-bold text-muted mb-1">Total Students with
                                            Notice/Memo</label>
            ...
            <div class="student-card">
                <div class="student-header">
                    <div>
                        ...
                        <div class="mt-2">
                            <span class="text-muted">
                                <i class="material-icons menu-icon material-symbols-rounded"
                                    style="font-size: 16px; vertical-align: middle;">email</i>
                                {{ $student['email'] ?? 'N/A' }}
                            </span>
                        </div>
                    </div>
                    <div class="record-count-badge">
                        <i class="material-icons menu-icon material-symbols-rounded"
                            style="font-size: 20px; vertical-align: middle;">description</i>
                    ...
                    <div class="record-item">
                        ...
                        <div class="record-details">
                            ...
                            <div class="detail-item">
                                ...
                                <span
                                    class="detail-value">{{ $record->session_date ? \Carbon\Carbon::parse($record->session_date)->format('d/m/Y') : 'N/A' }}</span>
                            </div>
                            <div class="detail-item">
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value">
                                    <span
                                        class="status-badge {{ $record->status == 1 ? 'status-open' : 'status-close' }}">
                                        {{ $record->status == 1 ? 'Open' : 'Close' }}
                                    </span>
                                </span>
                            </div>
                        ...
                        <div class="conversation-section">
                            ...
                            <div class="conversation-item">
                                ...
                                <div class="mt-2">
                                    <a href="{{ asset('storage/' . $conversation->doc_upload) }}" target="_blank"
                                        class="btn btn-sm btn-outline-primary">
                                        <i class="material-icons menu-icon material-symbols-rounded"
                                            style="font-size: 16px;">file_download</i>
                                        View Document
                                    </a>
                                </div>
                                @endif
