...
@section('title', 'Edit State - Sargam | Lal Bahadur')
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            <form action="{{ route('master.state.update', encrypt($state->pk)) }}" method="POST">
                @csrf
                @method('POST')
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="country_master_pk" name="country_master_pk" required>
                                ...
                                <option value="{{ $country->pk }}"
                                    {{ old('country_master_pk', $state->country_master_pk) == $country->pk ? 'selected' : '' }}>
