                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="date_of_memo" name="date_of_memo" required value="{{ old('date_of_memo') }}">
                            @error('date_of_memo')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="discipline_master_pk" class="form-control" id="discipline_pk" required>
                                ...
                                @foreach ($disciplines as $discipline)
                                    <option value="{{ $discipline->pk }}" {{ old('discipline_master_pk') == $discipline->pk ? 'selected' : '' }}>{{ $discipline->discipline_name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="text-end gap-3">
                            <button type="submit" class="btn btn-danger" name="submission_type" value="1">Save</button>
