<div class="row g-3 mw-step-grid">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <x-input name="id" label="Employee ID" type="text" value="{{ $member->emp_id ?? old('id') }}" placeholder="eg. EMP001" formLabelClass="form-label" formInputClass="form-control" labelRequired="true" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <x-input name="userid" label="User ID" type="text" value="{{ $member->userCredential->user_name ?? old('userid') }}" placeholder="eg. john.doe" formLabelClass="form-label" formInputClass="form-control" labelRequired="true" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
