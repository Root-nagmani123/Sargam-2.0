...
<div class="row g-3 mw-step-grid">
    <div class="col-md-6">
        <div class="mb-3">
            <x-input name="address" label="Address" placeholder="Street, area, landmark" formLabelClass="form-label" formInputClass="form-control" value="{{ $member->current_address ?? '' }}" labelRequired="true" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <x-input name="postal" label="Postal Code" placeholder="eg. 110001" formLabelClass="form-label" formInputClass="form-control" value="{{ $member->zipcode ?? '' }}" labelRequired="true" />
        </div>
    </div>
</div>
...
<div class="row g-3 mw-step-grid">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="permanentaddress" id="permanentaddress" class="form-control" placeholder="Street, area, landmark" value="{{ $member->permanent_address ?? '' }}">
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="permanentpostal" name="permanentpostal" placeholder="eg. 110001" value="{{ $member->pzipcode ?? '' }}">
        </div>
    </div>
</div>
...
<div class="row g-3 mw-step-grid">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="email" name="personalemail" id="personalemail" class="form-control" placeholder="name@email.com" value="{{ $member->email ?? '' }}">
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <label class="form-label" for="officialemail">Official Email <span class="text-danger">*</span></label>
            <input type="email" name="officialemail" id="officialemail" class="form-control" placeholder="name@organisation.gov.in" value="{{ $member->officalemail ?? '' }}">
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <label class="form-label" for="mnumber">Mobile Number <span class="text-danger">*</span></label>
            <input type="number" name="mnumber" id="mnumber" class="form-control only-numbers" placeholder="eg. 9876543210" value="{{ $member->mobile ?? '' }}">
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <label class="form-label" for="emergencynumber">Emergency Contact Number</label>
            <input type="number" class="form-control only-numbers" id="emergencynumber" name="emergencynumber" placeholder="eg. 9876543210" value="{{ $member->emergency_contact_no ?? '' }}">
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <label class="form-label" for="landlinenumber">Landline Number</label>
            <input type="number" class="form-control only-numbers" id="landlinenumber" name="landlinenumber" placeholder="eg. 0112345678" value="{{ $member->landline_contact_no ?? '' }}">
        </div>
    </div>
</div>
