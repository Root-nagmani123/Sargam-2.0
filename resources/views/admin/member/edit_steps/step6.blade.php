<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <x-input type="number" step="0.01" min="0" name="basicpay" formLabelClass="form-label" formInputClass="form-control" label="Basic Pay :" id="basicpay" value="{{ old('basicpay', $payrollSalary->basic_pay ?? '') }}" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
