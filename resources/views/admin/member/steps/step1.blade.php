<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <x-input name="father_husband_name" label="Father's/Husband's Name :" type="text" value="{{ old('father_husband_name') }}" formLabelClass="form-label" formInputClass="form-control letters-with-space" labelRequired="true" />
