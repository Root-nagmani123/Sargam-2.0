...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            <x-select name="country" label="Country" placeholder="Select Country" formLabelClass="form-label" formSelectClass="form-select" :options="$countryOptions ?? []" labelRequired="true" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <x-select name="state" label="State" placeholder="Select State" formLabelClass="form-label" formSelectClass="form-select" :options="$stateOptions ?? []" labelRequired="true" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <x-select name="district" label="District" placeholder="Select District" formLabelClass="form-label" formSelectClass="form-select" :options="$districtOptions ?? []" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <x-select name="city" label="City" placeholder="Select City" formLabelClass="form-label" formSelectClass="form-select" :options="$cityOptions ?? []" labelRequired="true" />
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <x-input name="address" label="Address" placeholder="eg. 3005 Cranberry, Wareham MA" formLabelClass="form-label" formInputClass="form-control" labelRequired="true" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <x-input name="postal" label="Postal Code" placeholder="eg. 123456" formLabelClass="form-label" formInputClass="form-control" labelRequired="true" />
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            <x-select name="permanentcountry" label="Country" placeholder="Select Country" formLabelClass="form-label" formSelectClass="form-select" :options="$countryOptions ?? []" labelRequired="true" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <x-select name="permanentstate" label="State" placeholder="Select State" formLabelClass="form-label" formSelectClass="form-select" :options="$stateOptions ?? []" labelRequired="true" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <x-select name="permanentdistrict" label="District" placeholder="Select District" formLabelClass="form-label" formSelectClass="form-select" :options="$districtOptions ?? []" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <x-select name="permanentcity" label="City" placeholder="Select City" formLabelClass="form-label" formSelectClass="form-select" :options="$cityOptions ?? []" labelRequired="true" />
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="email" name="officialemail" id="officialemail" class="form-control"
                placeholder="eg. yourmail@companyname.com">
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
