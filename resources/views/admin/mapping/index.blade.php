...
<div class="container-fluid">
    <div class="card card-body py-3" style="border-left:4px solid #004384;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="float-end gap-2">
                                <a href="{{route('mapping.create')}}" class="btn btn-primary">+ Add Faculty Topic Mapping</a>
                            </div>
                        </div>
                    </div>
                    <hr>
                        ...
                        <table id="zero_config"
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="col">Major Subject</th>
                                    <th class="col">Topic</th>
                                    <th class="col">Faculties</th>
                                    <th class="col">Minor Subject</th>
