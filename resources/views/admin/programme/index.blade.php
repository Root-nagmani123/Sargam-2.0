...
#coursemaster-table tbody td { white-space: nowrap; }
#coursemaster-table tbody tr:hover { background-color: rgba(var(--bs-primary-rgb), 0.08) !important; }
#coursemaster-table .form-check-input:checked { background-color: var(--bs-primary); border-color: var(--bs-primary); }
