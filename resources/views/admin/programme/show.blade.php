        ...
        <div
                ...
                <ol class="breadcrumb mb-0 align-items-center flex-wrap gap-1 gap-md-2">
                    <li class="breadcrumb-item">
                        <a href="{{ route('programme.index') }}"
                            class="text-decoration-none text-primary d-inline-flex align-items-center fw-medium">
            ...
            <div class="d-flex flex-wrap gap-2" role="group" aria-label="Course actions">
                ...
                <a href="{{ route('programme.download.pdf', ['id' => encrypt($course->pk)]) }}"
                    class="btn btn-danger btn-sm d-inline-flex align-items-center" aria-label="Download PDF">
                ...
                <div class="row align-items-center g-3">
                    ...
                    <div class="col-12 col-lg-4 text-lg-end">
                        <p class="text-white-50 small mb-0">
                            Last updated:
                            {{ \Carbon\Carbon::parse($course->updated_at ?? now())->format('d M Y, h:i A') }}
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <section class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4" aria-labelledby="course-info-title">
                <div class="card-header bg-body-secondary border-0 py-3">
                    <h2 class="h5 mb-0 fw-bold d-flex align-items-center gap-2" id="course-info-title">
                        <span class="rounded-2 p-2 bg-primary bg-opacity-10 text-primary"><i
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <label class="form-label small text-body-secondary text-uppercase fw-semibold mb-1">Course
                                Name</label>
                            <p class="mb-0 border-start border-3 border-primary ps-3 py-2 bg-body-tertiary rounded-end">
                                {{ $course->course_name }}</p>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label small text-body-secondary text-uppercase fw-semibold mb-1">Short
                                Name</label>
                            <p class="mb-0 border-start border-3 border-primary ps-3 py-2 bg-body-tertiary rounded-end">
                                {{ $course->couse_short_name }}</p>
                        </div>
                        @if($course->duration)
                        <div class="col-sm-6">
                            <label
                                class="form-label small text-body-secondary text-uppercase fw-semibold mb-1">Duration</label>
                            <p class="mb-0 border-start border-3 border-primary ps-3 py-2 bg-body-tertiary rounded-end">
                                {{ $course->duration }}</p>
                        </div>
                        @endif
                    ...
                    <div class="mt-4 pt-3 border-top">
                        <label
                            class="form-label small text-body-secondary text-uppercase fw-semibold mb-2">Description</label>
            ...
            <section class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4" aria-labelledby="faculty-title">
                <div
                    class="card-header bg-body-secondary border-0 py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
                    <h2 class="h5 mb-0 fw-bold d-flex align-items-center gap-2" id="faculty-title">
                        <span class="rounded-2 p-2 bg-primary bg-opacity-10 text-primary"><i
                                class="bi bi-people-fill"></i></span>
                        Course Faculty Team
                    </h2>
                    <span class="badge bg-primary rounded-pill">{{ count($assistantCoordinatorsData) + 1 }}
                        Members</span>
                </div>
                <div class="card-body p-4">
                    <!-- Coordinator -->
                    ...
                    <div
                        class="card border-0 bg-warning bg-opacity-10 border-start border-4 border-warning rounded-3 mb-4">
                        <div class="card-body p-4">
                            <div class="row align-items-center g-4">
                                <div class="col-auto">
                                    <div class="position-relative">
                                        <img src="{{ asset('storage/' . ($coordinatorFaculty->photo_uplode_path ?? 'default-profile.jpg')) }}"
                                            ...
                                            width="80" height="80">
                                        <span
                                            class="position-absolute bottom-0 end-0 badge bg-warning text-dark rounded-circle p-1">
                                ...
                                <div class="col">
                                    ...
                                    <p class="text-body-secondary mb-1 small d-flex align-items-center gap-2">
                                        <i
                                            class="bi bi-briefcase text-primary"></i>{{ $coordinatorFaculty->designation }}
                                    </p>
                                    @endif
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div
                                class="card h-100 border border-body-secondary border-opacity-25 rounded-3 overflow-hidden">
                                <div class="card-body text-center p-4">
                                    ...
                                    <span
                                        class="badge bg-primary bg-opacity-10 text-primary mb-2">{{ $assistant['role'] }}</span>
            ...
            <section class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4"
                ...
                <div class="card-body p-4">
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            <div
                                class="card h-100 border-0 bg-info bg-opacity-10 border-top border-3 border-info rounded-3">
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div
                                class="card h-100 border-0 bg-success bg-opacity-10 border-top border-3 border-success rounded-3">
                                <div class="card-body">
                                    <h3 class="h6 fw-bold mb-2 d-flex align-items-center gap-2 text-success">
                                        <i class="bi bi-check2-circle"></i> Learning Outcomes
                                    </h3>
                                    <p class="card-text text-body-secondary small mb-0">{{ $course->learning_outcomes }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div
                                class="card h-100 border-0 bg-warning bg-opacity-10 border-top border-3 border-warning rounded-3">
                                <div class="card-body">
            ...
            <div class="card border-0 shadow-sm rounded-3 overflow-hidden sticky-lg-top" style="top: 1rem;">
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
                        <li
                            class="list-group-item d-flex justify-content-between align-items-center border-0 py-3 px-4">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center py-3 px-4">
                            ...
                            <span
                                class="fw-semibold small">{{ \Carbon\Carbon::parse($course->start_year)->format('d M Y') }}</span>
                        </li>
                        @endif
                        @if($course->end_date)
                        <li class="list-group-item d-flex justify-content-between align-items-center py-3 px-4">
                            ...
                            <span
                                class="fw-semibold small">{{ \Carbon\Carbon::parse($course->end_date)->format('d M Y') }}</span>
                        </li>
                        @endif
                    </ul>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (printBtn) {
        printBtn.addEventListener('click', function(e) {
            ...
            this.innerHTML =
                '<span class="spinner-border spinner-border-sm me-2"></span>Preparing for print...';
            this.disabled = true;
