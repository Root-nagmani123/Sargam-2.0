...
<style>
    /* Canonical country/index look (new-design-index-page.md §3b) — scoped to .hostel-floor-page. */
    .hostel-floor-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
    .hostel-floor-page .status-pill.bg-success-subtle { color: #146c43; }
    .hostel-floor-page .status-pill.bg-danger-subtle  { color: #b02a37; }

    .hostel-floor-page .hf-act {
    ...
    .hostel-floor-page .hf-act i { font-size: 1.1rem; }
    .hostel-floor-page .hf-act--edit { color: #2563eb; }
    .hostel-floor-page .hf-act--del  { color: var(--bs-danger, #dc3545); }
    .hostel-floor-page .hf-act--del.is-disabled { color: var(--ds-ink-muted); cursor: not-allowed; }
</style>
@endpush
    ...
    <div class="d-flex flex-wrap justify-content-end gap-2 mb-3">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="{{ route('master.hostel.floor.export', 'csv') }}"><i class="bi bi-filetype-csv me-2" aria-hidden="true"></i>CSV</a></li>
                <li><a class="dropdown-item" href="{{ route('master.hostel.floor.export', 'pdf') }}"><i class="bi bi-filetype-pdf me-2" aria-hidden="true"></i>PDF</a></li>
            </ul>
        </div>
        <a href="{{ route('master.hostel.floor.export', 'print') }}" target="_blank" rel="noopener" class="btn programme-dt-btn-columns border-0 text-primary" title="Print">
...
<script>
    $(document).ready(function () {
        ...
        (function waitForHfDt(tries) {
            tries = tries || 0;
            if (!$.fn.DataTable.isDataTable(TABLE_ID)) {
                if (tries < 80) { setTimeout(function () { waitForHfDt(tries + 1); }, 150); }
                return;
            }
