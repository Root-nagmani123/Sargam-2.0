        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('master.memo.type.master.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="memo_type_name" class="form-label">Memo Type Name <span
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="file" name="memo_doc_upload" class="form-control" accept=".pdf,.doc">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select name="active_inactive" class="form-select" required>
                            <option value="1"
                                {{ (old('active_inactive', $memoType->active_inactive ?? 1) == 1) ? 'selected' : '' }}>
                                Active
                            </option>
                            <option value="2"
                                {{ (old('active_inactive', $memoType->active_inactive ?? 1) == 2) ? 'selected' : '' }}>
                                Inactive
                            </option>
                        </select>
