...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="medical_speciality_name" class="form-control" value="{{ old('medical_speciality_name', $speciality->speciality_name ?? '') }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="active_inactive" class="form-select">
                <option value="1" {{ (old('active_inactive', $speciality->active_inactive ?? 1) == 1) ? 'selected' : '' }}>Active</option>
                <option value="0" {{ (old('active_inactive', $speciality->active_inactive ?? 1) == 0) ? 'selected' : '' }}>Inactive</option>
            </select>
        </div>
