...
<script>
    $(function() {
        ...
        var mcmSearchTimer;
        $('#mcmTableSearch').on('keyup', function() {
            var value = this.value;
            clearTimeout(mcmSearchTimer);
            mcmSearchTimer = setTimeout(function() {
                table.search(value).draw();
            }, 400);
        });

        // 🧱 Column Visibility modal (chips built from the live DataTable)
        var $mcmColGrid = $('#mcmColumnsGrid');
        ...
        $(document).on('click', '.edit-btn', function(e) {
            ...
            const caseName = $(this).data('case_name');
