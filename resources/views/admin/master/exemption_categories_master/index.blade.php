...
<div class="container-fluid eccm-master-page">
    ...
    <div class="card eccm-dt-card border-0 shadow-sm rounded-3 overflow-hidden">
        <div class="card-body p-3 p-md-4">
            <div class="d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center justify-content-end gap-3 mb-4">
                <div id="eccmDtSearch" class="programme-dt-search ms-lg-auto" data-dt-search-for="exceptiongetcategory"></div>
            </div>
