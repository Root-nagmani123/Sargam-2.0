            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.path.page.save') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="register_course" class="form-control summernote"
                            required>{{ old('register_course', $pathPage->register_course ?? '') }}</textarea>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-semibold">Apply for Exemption <span
                                class="text-danger">*</span></label>
                        <textarea name="apply_exemption" class="form-control summernote"
                            required>{{ old('apply_exemption', $pathPage->apply_exemption ?? '') }}</textarea>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-semibold">Already Registered <span
                                class="text-danger">*</span></label>
                        <textarea name="already_registered" class="form-control summernote"
                            required>{{ old('already_registered', $pathPage->already_registered ?? '') }}</textarea>
                    </div>
                    ...
                    <div id="faq-wrapper">
                        ...
                        <div class="row mb-3" data-id="{{ $faq->id }}">
                            ...
                            <div class="col-6">
                                ...
                                <textarea name="faq_content[]" class="form-control"
                                    rows="2">{{ $faq->content }}</textarea>
                            </div>
