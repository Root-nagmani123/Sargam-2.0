                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <div class="mt-3"> {{-- START FROM NEXT LINE --}}
                                ...
                                <img src="{{ asset($filePath) }}" alt="Signature" height="50" class="border rounded">
                    ...
                    <div class="col-12 mt-4">
                        <div class="mb-4">
                            ...
                            <textarea class="form-control text-dark" rows="5" name="important_updates"
                                id="important_updates">{!! old('important_updates', isset($data) ? $data->important_updates : '') !!}</textarea>
                        </div>
                    </div>
