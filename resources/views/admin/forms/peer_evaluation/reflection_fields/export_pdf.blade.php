{{-- Manage Reflection Fields → PDF (DomPDF).
...
<body>
    ...
    <div class="report-title">MANAGE REFLECTION FIELDS</div>
    <div class="meta">
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="{{ count($columns) }}" class="empty">No reflection fields to export</td></tr>
            @endforelse
        </tbody>
    </table>
