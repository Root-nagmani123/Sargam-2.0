...
<body onload="window.print();">
    ...
    <table class="ic-print-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="{{ count($columns) }}" class="ic-print-empty">No evaluators to print</td>
                </tr>
            @endforelse

            @if ($rows->count())
                {{-- Average across evaluators, per criterion - the same row the
                     on-screen report ends with. --}}
                <tr class="ic-print-total-row">
                    <td class="col-sno"></td>
