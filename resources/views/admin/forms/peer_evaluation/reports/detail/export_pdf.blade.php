...
<head>
    ...
    <style>
        ...
        * { font-family: 'DejaVu Sans', sans-serif; }
        ...
        table.data-table tbody tr.total-row { background: #eef2f8; font-weight: bold; }
        .col-course  { width: 14%; }
...
<body>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="{{ count($columns) }}" class="empty">No evaluators to export</td></tr>
            @endforelse

            @if ($rows->count())
                <tr class="total-row">
                    <td class="col-sno"></td>
                    <td class="col-name"><strong>Average</strong></td>
