...
<head>
    <meta charset="utf-8">
    <title>Manage Events — LBSNAA</title>
    <style>
...
<body>
    ...
    <div class="report-title">MANAGE EVENTS</div>
    <div class="meta">
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="{{ count($columns) }}" class="empty">No events to export</td></tr>
            @endforelse
        </tbody>
    </table>
