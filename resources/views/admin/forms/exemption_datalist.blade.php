                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-end">
                            <form action="{{ route('admin.exemption.export') }}" method="GET" class="d-flex align-items-center gap-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($data->medical_exemption_doc)
                                            <a href="{{ asset('storage/' . $data->medical_exemption_doc) }}" target="_blank" class="btn btn-sm btn-info">View</a>
                                        @else
