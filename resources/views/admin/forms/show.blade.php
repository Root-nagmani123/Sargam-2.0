                                                    ...
                                                    @foreach ($gridFields[$section->id] as $field)
                                                        <div class="col-md-6 mb-3">
                                                            @include('admin.forms.field-types', [
                                                                'field' => $field,
                                                                'value' =>
                                                                    $submissions[$field->formname]->fieldvalue ??
                                                                    null,
