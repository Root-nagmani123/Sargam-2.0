                        ...
                        <table class="table table-bordered align-middle text-center table-hover table-striped text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ asset('admin_assets/sample/joining_documents/sample_close_relations_2.pdf') }}" class="btn btn-link p-0 text-primary" target="_blank">View Sample</a></td>
                                    <td class="text-center">
                                        @if (!empty($documents->accounts_nomination_form))
                                            <a href="{{ asset('storage/' . $documents->accounts_nomination_form) }}"
                                                download class="btn btn-sm btn-outline-primary">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ asset('admin_assets/sample/joining_documents/sample_nps_form10.pdf') }}" class="btn btn-link p-0 text-primary" target="_blank">View Sample</a></td>
                                    <td>
                                        @if (!empty($documents->accounts_nps_registration))
                                            <a href="{{ asset('storage/' . $documents->accounts_nps_registration) }}"
                                                download class="btn btn-sm btn-outline-primary">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ asset('admin_assets/sample/joining_documents/sample_employee_information11.pdf') }}" class="btn btn-link p-0 text-primary" target="_blank">View Sample</a></td>
                                    <td>
                                        @if (!empty($documents->accounts_employee_info_sheet))
                                            <a href="{{ asset('storage/' . $documents->accounts_employee_info_sheet) }}"
                                                download class="btn btn-sm btn-outline-primary">
