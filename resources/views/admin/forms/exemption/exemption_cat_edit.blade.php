...
@section('title', 'Edit Exemption')

@section('setup_content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="fw-bold">Edit Exemption</h4>
            ...
            <form method="POST" action="{{ route('exemptionUpdate', $item->pk) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Exemption_name" id="Exemption_name"
                        value="{{ old('Exemption_name', $item->Exemption_name) }}" required>
                </div>

                <div class="mb-3">
                    <label for="description" class="form-label">Exemption Subheading <span
                            class="text-danger">*</span></label>
                    <textarea class="form-control" name="description" id="description" rows="4" required>{{ old('description', $item->description) }}</textarea>
                </div>
