...
<x-fonts-sargam />
{{-- UX4G Design System (Phase 2) is vendored and build-ready but NOT globally
     loaded: even tamed + layered, its base/table/form-control rules restyle
     elements the existing theme doesn't fully control (~14 pages changed in the
     Phase 2 gate). UX4G is instead activated per-component in later phases with
     controlled, reviewed diffs. Files: public/css/ux4g-vendor.css (tamed UX4G,
     @layer ux4g) + public/css/ux4g-app.css (brand tokens, @layer tokens), built
     by `npm run build:ux4g`. See docs/UX4G-Decision-Note-R1-R2-R3.md. --}}
<!-- Core Css -->
