                    ...
                    <ul class="navbar-nav flex-row mx-auto ms-lg-auto align-items-center justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link moon dark-layout nav-icon-hover-bg rounded-circle"
                                ...
                                <iconify-icon icon="solar:moon-line-duotone" class="moon fs-6" style="display: flex;">
                                </iconify-icon>
                            </a>
                            <a class="nav-link sun light-layout nav-icon-hover-bg rounded-circle"
                                href="javascript:void(0)" style="display: none">
                                <iconify-icon icon="solar:sun-2-line-duotone" class="sun fs-6" style="display: none;">
                                </iconify-icon>
                            </a>
                        </li>
                                                    ...
                                                    <div class="simplebar-content" style="padding: 0px;">
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            <div class="w-75">
                                                                ...
                                                                <span
                                                                    class="d-block text-truncate text-truncate fs-11">Just
                                                        ...
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            <div class="w-75">
                                                                ...
                                                                <span
                                                                    class="d-block text-truncate text-truncate fs-11">You
