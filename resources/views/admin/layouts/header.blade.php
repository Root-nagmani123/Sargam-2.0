<header class="topbar">
    ...
    <div class="bg-dark text-white border-bottom border-primary" style="height: 40px;" role="banner">
        <div class="px-3">
                ...
                <nav aria-label="Utility Navigation">
                    <ul class="list-inline mb-0 d-flex align-items-center gap-3 small">
                        ...
                        <li class="list-inline-item d-flex align-items-center gap-1" aria-label="Font size controls">
                            <a href="javascript:void(0)" class="text-white px-2" aria-label="Decrease font size">A-</a>
                            <a href="javascript:void(0)" class="text-white px-2" aria-label="Normal font size">A</a>
                            <a href="javascript:void(0)" class="text-white px-2" aria-label="Increase font size">A+</a>
                        </li>
        ...
        <nav class="navbar navbar-expand-lg p-0">
            ...
            <div class="d-flex align-items-center gap-2 py-2 py-xl-0">
                <img src="{{ asset('images/ashoka.webp') }}" alt="Ashoka emblem" style="height: 40px;">
                <span class="text-muted d-none d-sm-inline">|</span>
                <img src="{{ asset('admin_assets/images/logos/logo.svg') }}" alt="{{ config('app.name', 'LBSNAA') }}"
            ...
            <div class="nav-container d-lg-none">
                <ul class="navbar-nav mobile-tabbar" role="menubar" aria-label="Main navigation mobile">
                    <!-- Home -->
                    <li class="nav-item" role="none">
                        <a href="#home" class="nav-link active mobile-tab-link" data-bs-toggle="tab" role="tab"
                            aria-selected="true" aria-controls="home-panel" id="home-tab-mobile">
                    ...
                    <!-- Setup -->
                    <li class="nav-item" role="none">
                        <a href="#tab-setup" class="nav-link mobile-tab-link" data-bs-toggle="tab" role="tab"
                            aria-selected="false" aria-controls="setup-panel" id="setup-tab-mobile">
                    ...
                    <li class="nav-item" role="none">
                        <a href="#" class="nav-link mobile-tab-link" data-bs-toggle="tab" role="tab"
                            aria-selected="false" aria-controls="communications-panel" id="communications-tab-mobile">
                    ...
                    <!-- Search -->
                    <li class="nav-item" role="none">
                        <button class="nav-link mobile-tab-link search-trigger" aria-label="Open search"
            ...
            function initializeCollapseOnMobile() {
                ...
                collapseButtons.forEach(collapseBtn => {
                    ...
                    collapseBtn.addEventListener('click', function(e) {
                        const targetId = this.getAttribute('data-bs-target') || this
                            .getAttribute('href');
                        if (!targetId) return;
