                                ...
                                <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                                    <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                        ...
                                        <div class="simplebar-content" style="padding: 0px;">
                                            ...
                                            <li class="mini-nav-item {{ (request()->routeIs('admin.dashboard') || request()->routeIs('admin.communications.hub') || request()->is('dashboard') || request()->is('communications')) ? 'selected' : '' }}"
                                                id="mini-1">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const isDashboard = {
            {
                (request() - > routeIs('admin.dashboard') || request() - > is('dashboard')) ? 'true' : 'false'
            }
        };
        ...
        function showSidebarMenu(miniId) {
            const miniNav = sidebarHome.querySelector('.mini-nav');
