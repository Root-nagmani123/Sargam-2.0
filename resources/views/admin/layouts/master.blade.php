...
<head>
    <!-- Block dark mode before any CSS - prevents flash on system dark theme -->
    <style id="critical-light-mode">
        :root, html, body { color-scheme: light !important; --bs-body-bg: #fff !important; --bs-body-color: #212529 !important; }
        @media (prefers-color-scheme: dark) {
            :root, html, body { color-scheme: light !important; --bs-body-bg: #fff !important; --bs-body-color: #212529 !important; }
        }
    </style>
    <!-- Always force light theme (ignore system theme and localStorage) -->
    <script>
        (function() {
            'use strict';
            try {
