...
@section('content')
    ...
    <div class="container-fluid">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="program_name" name="program_name">
                                ...
                                @foreach ($programs as $p)
                                    <option value="{{ $p->pk }}">{{ $p->course_name }}</option>
                                @endforeach
                            </select>
                                        ...
                                        <td class="conversation">
                                            <div class="d-flex align-items-center gap-2 flex-nowrap">
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-type="admin" data-id="{{ $memo->notice_id }}"
                                                ...
                                                @elseif($memo->type_notice_memo == 'Memo' && in_array($memo->communication_status, [1, 2]))
                                            ...
                                            @if ($memo->type_notice_memo == 'Notice')
                                                @if ($memo->status == 1)
                                                    <button type="button" class="btn btn-sm btn-secondary" disabled
                                                        ...
                                                        title="Memo generation not available yet">
                                                        <i class="bi bi-file-earmark-lock me-1"></i> Generate Memo
                                                    </button>
                                                @elseif($memo->status == 2)
                                                    <a href="javascript:void(0)"
                                                        class="btn btn-sm btn-success generate-memo-btn"
        ...
        <div class="modal fade" id="memo_generate" tabindex="-1" aria-labelledby="memo_generateLabel"
            aria-hidden="true">
                        ...
                        <form action="{{ route('memo.notice.management.store_memo_status') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="date_memo_notice"
                                        name="date_memo_notice" required readonly>
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" id="subject_master_id" class="form-control"
                                        name="subject_master_id" readonly>
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" id="memo_number" name="memo_number" class="form-control"
                                        readonly>
                                    @error('memo_number')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="textarea" name="Remark" rows="3" placeholder="Enter remarks..."></textarea>
                                    @error('Remark')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
    ...
    <script>
        $(document).ready(function() {
            $('.view-conversation').on('click', function() {
                ...
                $.ajax({
                    url: '/admin/memo-notice-management/get_conversation_model/' + memoId + '/' +
                        type,
                    type: 'GET',
