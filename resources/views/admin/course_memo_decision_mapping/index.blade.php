    ...
    $(function() {
        ...
        if (!$.fn.DataTable.isDataTable(tableSelector)) {
            const memoDecisionTable = $(tableSelector).DataTable({
                processing: true,
                serverSide: true,
                // Filters are applied in the preXhr.dt handler above, which reads
                // the toolbar's #cmdmCourseFilter. The old ajax.data callback read
                // #courseFilter / #memoConclusionFilter from the removed block.
            ...
            // Filter change / reset are handled by the toolbar handlers further
            // down (#cmdmCourseFilter, #cmdmResetFilters).
        }
