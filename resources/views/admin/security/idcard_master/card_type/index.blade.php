...
<style>
    /* Canonical country/index look (new-design-index-page.md §3b) — scoped to .cardtype-master-page. */
    .cardtype-master-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
    .cardtype-master-page .status-pill.bg-success-subtle { color: #146c43; }
    .cardtype-master-page .status-pill.bg-danger-subtle  { color: #b02a37; }

    .cardtype-master-page .ct-act {
    ...
    .cardtype-master-page .ct-act i { font-size: 1.1rem; }
    .cardtype-master-page .ct-act--edit { color: #2563eb; }
    .cardtype-master-page .ct-act--del  { color: var(--bs-danger, #dc3545); }
</style>
@endpush
