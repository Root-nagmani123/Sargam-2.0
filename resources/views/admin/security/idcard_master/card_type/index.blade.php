...
<script>
    $(document).ready(function () {
        ...
        // Status toggles are handled globally by admin_assets/js/custom.js, which
        // reloads every .dataTable on success — that refreshes both the Status badge
        // and the Delete control (active rows can't be deleted).
    });
</script>
@endpush
