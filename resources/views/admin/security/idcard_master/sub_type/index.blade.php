...
<style>
    /* Canonical country/index look (new-design-index-page.md §3b) — scoped to .cardsubtype-master-page. */
    .cardsubtype-master-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
    .cardsubtype-master-page .status-pill.bg-success-subtle { color: #146c43; }
    .cardsubtype-master-page .status-pill.bg-danger-subtle  { color: #b02a37; }

    .cardsubtype-master-page .st-act {
    ...
    .cardsubtype-master-page .st-act i { font-size: 1.1rem; }
    .cardsubtype-master-page .st-act--edit { color: #2563eb; }
    .cardsubtype-master-page .st-act--del  { color: var(--bs-danger, #dc3545); }
</style>
@endpush
