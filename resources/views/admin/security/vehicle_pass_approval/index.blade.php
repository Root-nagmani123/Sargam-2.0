...
/* Row status pill tints + icon-over-label actions (new-design §3b) — scoped to .vehicle-approval-page. */
.vehicle-approval-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
.vehicle-approval-page .status-pill.bg-success-subtle   { color: #146c43; }
.vehicle-approval-page .status-pill.bg-danger-subtle    { color: #b02a37; }
.vehicle-approval-page .status-pill.bg-warning-subtle   { color: #b54708; }
.vehicle-approval-page .status-pill.bg-secondary-subtle { color: #475467; }

.vehicle-approval-page .vpa-act {
...
.vehicle-approval-page .vpa-act i { font-size: 1.1rem; }
.vehicle-approval-page .vpa-act--view    { color: #475467; }
.vehicle-approval-page .vpa-act--approve { color: #146c43; }
.vehicle-approval-page .vpa-act--reject  { color: var(--bs-danger, #dc3545); }
</style>
@endpush
