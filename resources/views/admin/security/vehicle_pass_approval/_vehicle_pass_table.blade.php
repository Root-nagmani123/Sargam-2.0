            ...
            <tbody>
                @forelse($applications as $app)
                    ...
                    <tr data-ts="{{ $ts }}">
                        ...
                        <td>
                            <span class="status-pill badge bg-{{ $app->status_class ?? 'secondary' }}-subtle">
                                {{ $app->status ?? '--' }}
                            </span>
                        </td>
