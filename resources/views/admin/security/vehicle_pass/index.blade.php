...
<style>
    /* Canonical country/index look (new-design-index-page.md §3b) — scoped to .vehicle-pass-index-page.
       Workflow status badges: green Approved / red Rejected / amber Pending. */
    .vehicle-pass-index-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
    .vehicle-pass-index-page .status-pill.bg-success-subtle { color: #146c43; }
    .vehicle-pass-index-page .status-pill.bg-danger-subtle  { color: #b02a37; }
    .vehicle-pass-index-page .status-pill.bg-warning-subtle { color: #b54708; }

    .vehicle-pass-index-page .vp-act {
    ...
    .vehicle-pass-index-page .vp-act i { font-size: 1.1rem; }
    .vehicle-pass-index-page .vp-act--view { color: #475467; }
    .vehicle-pass-index-page .vp-act--edit { color: #2563eb; }
    .vehicle-pass-index-page .vp-act--del  { color: var(--bs-danger, #dc3545); }
</style>
@endpush
...
<div class="container-fluid vehicle-pass-index-page">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
        ...
        <div class="d-flex align-items-center gap-2">
            <button type="button" class="btn programme-dt-btn-columns" id="vpPrintBtn" title="Print">
                <i class="bi bi-printer" aria-hidden="true"></i>
                <span>Print</span>
            </button>
            <div class="dropdown">
                <button type="button" class="btn programme-dt-btn-columns dropdown-toggle" id="vpDownloadBtn"
