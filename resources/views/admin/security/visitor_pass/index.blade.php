...
<style>
    /* Canonical country/index look (new-design-index-page.md §3b) — scoped to .visitor-pass-page.
       Soft workflow status pills + icon-over-label row actions. */
    .visitor-pass-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
    .visitor-pass-page .status-pill.bg-success-subtle { color: #146c43; }
    .visitor-pass-page .status-pill.bg-danger-subtle  { color: #b02a37; }
    .visitor-pass-page .status-pill.bg-warning-subtle { color: #b54708; }

    .visitor-pass-page .vis-act {
    ...
    .visitor-pass-page .vis-act i { font-size: 1.1rem; }
    .visitor-pass-page .vis-act--view     { color: #475467; }
    .visitor-pass-page .vis-act--checkout { color: #d97706; }
    .visitor-pass-page .vis-act--edit     { color: #2563eb; }
    .visitor-pass-page .vis-act--del      { color: var(--bs-danger, #dc3545); }
</style>
@endpush
