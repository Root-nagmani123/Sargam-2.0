...
<style>
    /* Canonical country/index look (new-design-index-page.md §3b) — scoped to .duplicate-vehicle-pass-page.
       Workflow status badges: green Approved / red Rejected / cyan Issued / amber Pending. */
    .duplicate-vehicle-pass-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
    .duplicate-vehicle-pass-page .status-pill.bg-success-subtle { color: #146c43; }
    .duplicate-vehicle-pass-page .status-pill.bg-danger-subtle  { color: #b02a37; }
    .duplicate-vehicle-pass-page .status-pill.bg-info-subtle    { color: #087990; }
    .duplicate-vehicle-pass-page .status-pill.bg-warning-subtle { color: #b54708; }

    .duplicate-vehicle-pass-page .dvp-act {
    ...
    .duplicate-vehicle-pass-page .dvp-act i { font-size: 1.1rem; }
    .duplicate-vehicle-pass-page .dvp-act--view { color: #475467; }
    .duplicate-vehicle-pass-page .dvp-act--edit { color: #2563eb; }
    .duplicate-vehicle-pass-page .dvp-act--del  { color: var(--bs-danger, #dc3545); }
</style>
@endpush
