@php
    ...
    $reportTitle = $reportTitle ?? 'Requested ID Card';
    ...
    $centerHeadings = ['S.No.', 'Request ID', 'Date of Birth', 'Blood Group', 'Request Date', 'Request Type'];
@endphp
<!doctype html>
<html lang="en">
<head>
...
<body @if($isPrint) onload="window.focus(); window.print();" @endif>
    ...
    @php
        $headingClassMap = [
            'S.No.' => 'col-sno',
            'Request ID' => 'col-reqid',
            'Employee Name' => 'col-name',
            'Designation' => 'col-desig',
            'ID Card No' => 'col-idcard',
            'Date of Birth' => 'col-dob',
            'Blood Group' => 'col-blood',
            'Mobile No' => 'col-mobile',
            'Request Date' => 'col-reqdate',
            'Request Type' => 'col-reqtype',
            'Card Type' => 'col-cardtype',
        ];
    @endphp
