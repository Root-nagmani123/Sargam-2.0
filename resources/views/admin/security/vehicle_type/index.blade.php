...
<style>
    /* Canonical country/index look (new-design-index-page.md §3b) — scoped to .vehicle-type-page. */
    .vehicle-type-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
    .vehicle-type-page .status-pill.bg-success-subtle { color: #146c43; }
    .vehicle-type-page .status-pill.bg-danger-subtle  { color: #b02a37; }

    .vehicle-type-page .vt-act {
    ...
    .vehicle-type-page .vt-act i { font-size: 1.1rem; }
    .vehicle-type-page .vt-act--edit { color: #2563eb; }
    .vehicle-type-page .vt-act--del  { color: var(--bs-danger, #dc3545); }
</style>
@endpush
