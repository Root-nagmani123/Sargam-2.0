...
<div class="container-fluid">
    <div class="card" style="border-left:4px solid #004a93;">
        ...
        <div class="card-body">
            <p class="text-muted">Please edit the vehicle pass configuration details below.</p>
            ...
            <form action="{{ route('admin.security.vehicle_pass_config.update', encrypt($config->pk)) }}" method="POST" id="updateVehiclePassConfigForm">
                @csrf
                @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sec_vehicle_type_pk" id="sec_vehicle_type_pk" class="form-select @error('sec_vehicle_type_pk') is-invalid @enderror" required>
                                ...
                                @foreach($vehicleTypes as $vt)
                                    <option value="{{ $vt->pk }}" 
                                        {{ (old('sec_vehicle_type_pk', $config->sec_vehicle_type_pk) == $vt->pk) ? 'selected' : '' }}>
                                        {{ $vt->vehicle_type }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="charges" id="charges" 
                                ...
                                value="{{ old('charges', $config->charges) }}" 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="start_counter" id="start_counter" 
                                ...
                                value="{{ old('start_counter', $config->start_counter) }}" 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="preview" class="form-control bg-light" readonly 
                                value="VP{{ now()->format('Ymd') }}{{ str_pad($config->start_counter, 4, '0', STR_PAD_LEFT) }}">
...
$(document).ready(function() {
    ...
    function updatePreview() {
        const counter = $('#start_counter').val() || 1;
    ...
    $('#start_counter').on('input', updatePreview);

    // Form validation
    $('#updateVehiclePassConfigForm').on('submit', function(e) {
