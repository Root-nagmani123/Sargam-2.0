...
<style>
    /* Canonical country/index look (new-design-index-page.md §3b) — scoped to .vehicle-pass-config-page. */
    .vehicle-pass-config-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
    .vehicle-pass-config-page .status-pill.bg-success-subtle { color: #146c43; }
    .vehicle-pass-config-page .status-pill.bg-danger-subtle  { color: #b02a37; }

    .vehicle-pass-config-page .vpc-act {
    ...
    .vehicle-pass-config-page .vpc-act i { font-size: 1.1rem; }
    .vehicle-pass-config-page .vpc-act--edit { color: #2563eb; }
    .vehicle-pass-config-page .vpc-act--del  { color: var(--bs-danger, #dc3545); }
</style>
@endpush
