...
/* §3b row visuals — status tint pills + icon-over-label actions (scoped to page root). */
.family-approval-page .status-pill { padding: 0.4em 0.85em; font-weight: 600; }
.family-approval-page .status-pill.bg-success-subtle   { color: #146c43; }
.family-approval-page .status-pill.bg-danger-subtle    { color: #b02a37; }
.family-approval-page .status-pill.bg-warning-subtle   { color: #b54708; }
.family-approval-page .status-pill.bg-secondary-subtle { color: #475467; }

.family-approval-page .fia-act {
...
.family-approval-page .fia-act i { font-size: 1.1rem; }
.family-approval-page .fia-act--view    { color: #475467; }
.family-approval-page .fia-act--approve { color: #146c43; }
.family-approval-page .fia-act--reject  { color: var(--bs-danger, #dc3545); }
</style>
@endpush
