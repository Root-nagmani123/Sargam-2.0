        ...
        <div class="card-body p-0">
            <div>
                <div id="active-panel">
                    ...
                    @include('components.mess-master-datatables', ['tableId' => 'activeIdcardTable', 'searchPlaceholder' => 'Search ID card requests...', 'orderColumn' => 0, 'actionColumnIndex' => 9, 'infoLabel' => 'requests', 'serverSide' => true, 'ajaxUrlBase' => route('admin.employee_idcard.index', ['grid' => 'active'])])
                </div>
                ...
                <div class="tab-pane fade" id="duplication-panel" role="tabpanel" aria-labelledby="duplication-tab">
                    ...
                    @include('components.mess-master-datatables', ['tableId' => 'duplicationIdcardTable', 'searchPlaceholder' => 'Search duplication requests...', 'orderColumn' => 0, 'actionColumnIndex' => 9, 'infoLabel' => 'requests', 'serverSide' => true, 'ajaxUrlBase' => route('admin.employee_idcard.index', ['grid' => 'duplication'])])
                </div>
                ...
                <div class="tab-pane fade" id="archive-panel" role="tabpanel" aria-labelledby="archive-tab">
                    ...
                    @include('components.mess-master-datatables', ['tableId' => 'archiveIdcardTable', 'searchPlaceholder' => 'Search archived requests...', 'orderColumn' => 0, 'actionColumnIndex' => 6, 'infoLabel' => 'requests', 'serverSide' => true, 'ajaxUrlBase' => route('admin.employee_idcard.index', ['grid' => 'archive'])])
                </div>
            </div>
        </div>
    </div>
