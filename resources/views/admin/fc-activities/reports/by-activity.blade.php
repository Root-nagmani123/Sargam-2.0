...
<div class="container-fluid px-3">
    <x-breadcrum title="FC Activities — detail"></x-breadcrum>
    <h4 class="fw-bold mb-3" style="color:#1a3c6e;">{{ $label }} <span class="text-muted small">({{ $menuid }})</span></h4>
    <div class="card border-0 shadow-sm"><div class="table-responsive">
        <table class="table table-sm table-hover mb-0 js-fc-datatable" data-export-title="FC Activities — {{ $label }}">
