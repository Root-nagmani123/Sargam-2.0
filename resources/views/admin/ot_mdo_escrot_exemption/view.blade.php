                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <div class="fs-5 fw-semibold text-primary">{{ $studentData['total_duty_count'] }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card duty-item">
                                        <div class="card-body">
                                            <h6 class="card-title mb-3" style="color: #004a93; font-weight: 600;">
                                                <i class="material-icons menu-icon material-symbols-rounded" style="font-size: 20px; vertical-align: middle;">event</i>
                                                Date: {{ $duty['date'] ? \Carbon\Carbon::parse($duty['date'])->format('d/m/Y') : 'N/A' }}
                                            </h6>
                                            <div class="row">
                                        ...
                                        <div class="duty-item">
                                            <div class="duty-details">
                                                <div class="detail-item">
                                                    ...
                                                    <span class="detail-value">{{ $duty['date'] ? \Carbon\Carbon::parse($duty['date'])->format('d/m/Y') : 'N/A' }}</span>
                                                </div>
                                                <div class="detail-item">
                                                    <span class="detail-label">Course:</span>
                                                    <span class="detail-value">{{ $duty['course'] }}</span>
