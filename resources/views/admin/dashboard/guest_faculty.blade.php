...
<style>
    ...
    #guess_faculty_wrapper .dataTables_length select.form-select,
    #guess_faculty_wrapper .dataTables_filter input.form-control {
        min-height: 2rem;
    }
        ...
        <div class="card-body p-3 p-md-4">
            <div class="datatables">
                <div class="table-responsive border border-light-subtle">
                    <table class="table table-hover table-striped align-middle text-nowrap mb-0" id="guess_faculty">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge rounded-pill badge-guest bg-success-subtle text-success border border-success-subtle">Guest</span>
                                </td>
                                <td>
