...
@section('content')
<link rel="stylesheet" href="{{ asset('css/inhouse_faculty.css') }}">

<div class="container-fluid px-2 px-md-3">
    <x-breadcrum title="Inhouse Faculty"></x-breadcrum>
    <div class="card inhouse-faculty-card border-0 shadow-sm rounded-1">
        <div class="card-body p-3 p-md-4">
            <div class="datatables">
                <div class="table-responsive">
                    <table class="table table-hover align-middle text-nowrap mb-0" id="inhouse">
