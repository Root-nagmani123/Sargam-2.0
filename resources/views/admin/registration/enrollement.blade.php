    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        <input type="text" id="enrolledSearch" class="form-control" placeholder="Search students...">
                    </div>
...
$(document).ready(function() {
    ...
    enrolledModalEl.addEventListener('show.bs.modal', function () {
        ...
        if (!currentCourseFilter) {
            $('#enrolledTableBody').html('<tr><td colspan="6" class="text-center text-muted">Please select a course from the form to load enrolled students.</td></tr>');
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setupEnrolledPagination(response.total || 0, response.current_page || 1, response.last_page || 1);
                } else {
    ...
    function setupEnrolledPagination(total, curPage, lastPage) {
        ...
        let startPage = 1, endPage = lastPage;
    ...
    function loadStudents() {
        ...
        $('#studentTable tbody').html('<tr><td colspan="7" class="text-center">Loading students...</td></tr>');
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $('#studentTable tbody').html('<tr><td colspan="7" class="text-center">' + response.message + '</td></tr>');
                }
            },
            error: function(xhr) {
                $('#studentTable tbody').html('<tr><td colspan="7" class="text-center">Error loading students</td></tr>');
                console.error('Error:', xhr.responseText);
            }
        });
    }
    ...
    function populateStudentTable(students) {
        ...
        if (!students || students.length === 0) {
            tableBody.html('<tr id="noDataRow"><td colspan="7" class="text-center">No students found for the selected filters</td></tr>');
            $('#studentCount').text(0);
            return;
        }
