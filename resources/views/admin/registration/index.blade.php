                ...
                <form action="{{ route('forms.index') }}" method="GET">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            ...
                            @if (request('search'))
                                <!-- Clear Search Button -->
                                <a href="{{ route('forms.index') }}" class="btn btn-secondary">Clear</a>
                            @endif
                        </div>
                    </div>
                </form>
                        ...
                        <tbody>
                            @foreach ($forms as $index => $form)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('forms.courseList', $form->id) }}"
                                            class="btn btn-sm btn-success">
                                            View 
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{ route('forms.pending', $form->id) }}" class="btn btn-sm btn-info">
                                            To Submit 
                                        </a>
                                    </td>
                                    ...
                                    <td class="d-flex gap-1">
                                        ...
                                        @if ($index < count($forms) - 1)
                                            <form action="{{ route('forms.movedown', $form->id) }}" method="POST">
                                                @csrf
