...
<div class="card" style="border-left: 4px solid #004a93;">
    ...
    <div class="card-body">
        <form action="{{ route('admin.mess.sale-counters.store') }}" method="POST">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('counter_name') is-invalid @enderror" 
                               id="counter_name" name="counter_name" value="{{ old('counter_name') }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('counter_code') is-invalid @enderror" 
                               id="counter_code" name="counter_code" value="{{ old('counter_code') }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="location" name="location" 
                               value="{{ old('location') }}" placeholder="e.g., Building A, Ground Floor">
                    </div>
                </div>
            </div>
