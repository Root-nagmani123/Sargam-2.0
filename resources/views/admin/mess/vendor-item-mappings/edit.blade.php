...
<div class="card" style="border-left: 4px solid #004a93;">
    ...
    <div class="card-body">
        <form action="{{ route('admin.mess.vendor-item-mappings.update', $mapping->id) }}" method="POST" id="editVendorMappingForm">
                ...
                <div class="d-flex gap-4">
                    <div class="form-check">
                        <input class="form-check-input mapping-type-radio" type="radio" name="mapping_type"
                               ...
                               {{ old('mapping_type', $mapping->mapping_type) === 'item_category' ? 'checked' : '' }}>
            ...
            @php($editCategoryIds = $mapping->mapping_type === \App\Models\Mess\VendorItemMapping::MAPPING_TYPE_ITEM_CATEGORY && $mapping->item_category_id ? [$mapping->item_category_id] : [])
            @php($editSubcategoryIds = $mapping->mapping_type === \App\Models\Mess\VendorItemMapping::MAPPING_TYPE_ITEM_SUB_CATEGORY && $mapping->item_subcategory_id ? [$mapping->item_subcategory_id] : [])
