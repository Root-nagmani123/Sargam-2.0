...
=======
    ...
    <div class="card-body">
        <form action="{{ route('admin.mess.vendor-item-mappings.update', $mapping->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('rate') is-invalid @enderror" 
                               id="rate" name="rate" value="{{ old('rate', $mapping->rate) }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="effective_from" name="effective_from" 
                               value="{{ old('effective_from', $mapping->effective_from ?? date('Y-m-d')) }}">
                    </div>
                </div>
            </div>
