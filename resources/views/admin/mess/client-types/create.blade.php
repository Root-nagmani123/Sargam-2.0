...
<div class="card" style="border-left: 4px solid #004a93;">
    ...
    <div class="card-body">
        <form action="{{ route('admin.mess.client-types.store') }}" method="POST">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('type_code') is-invalid @enderror" 
                               id="type_code" name="type_code" value="{{ old('type_code') }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('default_credit_limit') is-invalid @enderror" 
                               ...
                               value="{{ old('default_credit_limit', 0) }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="priority_level" name="priority_level" 
                               value="{{ old('priority_level', 0) }}" min="0">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="3" 
                          placeholder="Enter description for this client type">{{ old('description') }}</textarea>
            </div>
