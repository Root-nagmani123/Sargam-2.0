                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('menu_item_name') is-invalid @enderror" 
                               id="menu_item_name" name="menu_item_name" 
                               value="{{ old('menu_item_name', $menu->menu_item_name) }}" 
                        ...
                        <select class="form-select select2 @error('inventory_id') is-invalid @enderror" 
                            ...
                            @foreach($items as $item)
                                <option value="{{ $item->id }}" 
                                    {{ old('inventory_id', $menu->inventory_id) == $item->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('rate') is-invalid @enderror" 
                               id="rate" name="rate" value="{{ old('rate', $menu->rate) }}" 
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('effective_from') is-invalid @enderror" 
                               ...
                               value="{{ old('effective_from', $menu->effective_from ? $menu->effective_from->format('Y-m-d') : '') }}" required>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('effective_to') is-invalid @enderror" 
                               ...
                               value="{{ old('effective_to', $menu->effective_to ? $menu->effective_to->format('Y-m-d') : '') }}">
                        @error('effective_to')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
