            ...
            <form method="GET" action="{{ route('admin.mess.process-mess-bills-employee.index') }}" id="mainFilterForm">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2 d-flex gap-2">
                        <button type="submit" class="btn btn-primary shadow flex-grow-1 d-inline-flex align-items-center justify-content-center gap-1">
                            <i class="material-symbols-rounded" style="font-size: 1.1rem;">filter_list</i>
                            <span>Apply</span>
                        </button>
                        @php
                            $clearFilterParams = [];
            ...
            <form method="GET" action="{{ route('admin.mess.process-mess-bills-employee.index') }}" id="filterForm" class="no-print">
                ...
                <div class="d-flex flex-wrap justify-content-end align-items-right mb-3 gap-2">
                    <div class="d-flex align-items-center gap-2">
                        <a href="{{ route('admin.mess.process-mess-bills-employee.export') }}?{{ http_build_query(request()->only(['date_from', 'date_to', 'client_type', 'client_type_pk', 'buyer_name', 'search'])) }}" class="btn btn-outline-success shadow-sm d-inline-flex align-items-center gap-2 px-3" title="Export to Excel">
