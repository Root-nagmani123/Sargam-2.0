...
<div class="card" style="border-left: 4px solid #004a93;">
    <div class="card-header">
        <h5 class="mb-0">
            ...
            Create Sale Counter Mapping
        </h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.mess.sale-counter-mappings.store') }}" method="POST">
            @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('sale_counter_id') is-invalid @enderror" 
                            ...
                            @foreach($counters as $counter)
                                <option value="{{ $counter->id }}" {{ old('sale_counter_id') == $counter->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('available_quantity') is-invalid @enderror" 
                               id="available_quantity" name="available_quantity" value="{{ old('available_quantity', 0) }}" 
