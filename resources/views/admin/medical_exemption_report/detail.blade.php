...
@push('styles')
{{-- Shared with the report index: same module, same components
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm mer-download-menu py-2" aria-labelledby="merDownloadBtn">
                <li><button type="button" class="dropdown-item d-flex align-items-center gap-2 py-2" id="merExportPdf">
                    <i class="bi bi-filetype-pdf text-danger" aria-hidden="true"></i><span>Download PDF</span>
                </button></li>
        ...
        <div class="ds-card">
            <div class="ds-card-body">
                ...
                <div class="mer-filterbar programme-dt-toolbar d-flex flex-wrap align-items-center gap-3 mb-4">
                    ...
                    <select id="mer_category_filter" class="form-select form-select-sm" aria-label="Exemption Category">
                    ...
                    {{-- Medical Case --}}
                    <div class="programme-dt-filter-select">
                    <select id="mer_case_filter" class="form-select form-select-sm" aria-label="Medical Case">
                            ...
                            <div class="dataTables_filter">
                                <label>
                                    <input type="search" id="mer_search" class="form-control form-control-sm"
                                        placeholder="Search case, category, remarks..." autocomplete="off" aria-label="Search">
                                </label>
                            </div>
                        </div>
                    </div>
