                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6 d-flex justify-content-end gap-2">
                            ...
                            <button type="button" class="btn btn-info d-flex align-items-center" data-bs-toggle="modal"
                                ...
                                <iconify-icon icon="mdi:account-plus" width="1.2em" height="1.2em" class="me-1">
                                </iconify-icon> Add Student
                            </button>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="studentGroupName" class="form-label">Group Name <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select" id="studentGroupName" name="group_name" required
                                                disabled>
...
$(document).ready(function() {
    ...
    $('#studentGroupType').on('change', function() {
        ...
        if (!groupTypeId || !groupTypeName) {
            ...
            groupNameHelp.text('Please select a group type first').removeClass('text-success').addClass(
                'text-muted');
            return;
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status === 'success' && response.group_names && response
                    ...
                    groupNameSelect.html('<option value="">No group names found</option>')
                        .prop('disabled', true);
