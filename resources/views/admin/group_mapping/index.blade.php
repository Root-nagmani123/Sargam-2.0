                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                                        <div>
                                                            ...
                                                            <small class="text-muted">Custom message to selected OTs</small>
                                                        </div>
                                                        <button type="button" class="btn-close btn-close-sm" id="closeBulkMessage" aria-label="Close"></button>
                                                    </div>

                                                    <div id="bulkMessageAlert" class="alert d-none" role="alert"></div>

                                                    <div class="mb-3">
                                                        <label for="bulkMessageText" class="form-label mb-1">Message</label>
                                                        <textarea id="bulkMessageText" class="form-control" rows="4" maxlength="1000" placeholder="Type your message here..."></textarea>
