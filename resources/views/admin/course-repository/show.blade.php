...
document.addEventListener('submit', function uploadFormSubmitHandler(e) {
    ...
    try {
        ...
        if (selectedCategory === 'Course') {
            ...
            if (!formData.get('sector_master')) requiredMissing('Sector');
            if (!formData.get('ministry_master')) requiredMissing('Ministry');
            ...
            if (!formData.get('sector_master_other')) requiredMissing('Sector');
            if (!formData.get('ministry_master_other')) requiredMissing('Ministry');
