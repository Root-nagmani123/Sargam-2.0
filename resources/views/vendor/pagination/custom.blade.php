...
{{-- Phase 7 (Navigation): accessibility attributes added — aria-label on the nav,
     accessible names for Prev/Next, aria-current on the active page, aria-hidden on
     decorative glyphs/ellipsis. All are semantic-only: ZERO visual change. --}}
