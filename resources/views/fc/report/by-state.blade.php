...
<div class="container-fluid px-3 choices-bs-scope">
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('admin.reports.export', 'state') }}{{ request()->getQueryString() ? '?'.request()->getQueryString() : '' }}" class="btn btn-sm btn-success"><i class="bi bi-file-earmark-spreadsheet me-1"></i>Export CSV</a>
        </div>
    </div>
