...
<main style="flex: 1;">
    <div class="container mt-5">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold text-center" style="color: #004a93; font-size: 20px;">
                            {{ $data->cse_heading ?? 'Exemption for CSE Mains 2024' }}
                        </h5>
                        <span class="text-muted">{{ $data->cse_subheading ?? 'For candidates appearing in Civil Services Mains Examination 2024' }}</span>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold text-center" style="color: #004a93;">
                            {{ $data->attended_heading ?? 'Already Attended Foundation Course' }}
                        </h5>
                        <span class="text-muted">{{ $data->attended_subheading ?? 'For officers who have previously completed the Foundation Course' }}</span>
                        <a href="{{ route('fc.exemption_application') }}" class="btn btn-success custom-btn"
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold text-center" style="color: #004a93;">
                            {{ $data->medical_heading ?? 'Medical Grounds' }}
                        </h5>
                        <span class="text-muted">{{ $data->medical_subheading ?? 'For candidates unable to attend due to medical reasons' }}</span>
                        <a href="{{ route('fc.exemption_application') }}" class="btn btn-success custom-btn"
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold text-center" style="color: #004a93;">
                            {{ $data->optout_heading ?? 'Opting Out After Registration' }}
                        </h5>
                        <span class="text-muted">{{ $data->optout_subheading ?? 'For candidates who wish to withdraw after initial registration' }}</span>
                        <a href="{{ route('fc.exemption_application') }}" class="btn btn-success custom-btn"
        ...
        <!-- Important Notice -->
        @if(!empty($data->important_notice))
