...
<body>
    ...
    <div class="body">
        मैं, {!! $blank($name, '300px') !!} (परिवीक्षाधीन का नाम और पता), {!! $blank($svc, '90px') !!} सेवा में परिवीक्षाधीन व्यक्ति
    ...
    <div class="body">
        अब, परिवीक्षाधीन और मैं, {!! $blank($sname, '200px') !!} निवासी {!! $blank($saddr, '240px') !!},
        {!! $blank($socc, '150px') !!} (प्रतिभू का नाम और पता, जिसे इसमें आगे &lsquo;प्रतिभू&rsquo; कहा गया है), उक्त नियमों के अनुसरण में
