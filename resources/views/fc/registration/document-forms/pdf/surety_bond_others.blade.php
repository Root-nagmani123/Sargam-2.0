...
<body>
    ...
    <div class="body">
        जबकि मैं, {!! $blank($name, '300px') !!} (परिवीक्षाधीन का पूरा नाम और पता), संघ लोक सेवा आयोग द्वारा सिविल सेवा परीक्षा,
        20{!! $blank($exyear, '60px') !!} के परिणाम के आधार पर की गई सिफारिश के अनुसार {!! $blank($svc, '180px') !!} (सेवा का नाम) में
        नियुक्त उम्मीदवार, जिसे इसमें आगे &lsquo;परिवीक्षाधीन&rsquo; कहा गया है, भर्ती नियमों के अनुपालन के अधीन {!! $blank($srule, '170px') !!}
    ...
    <div class="body">
        और जबकि परिवीक्षाधीन को इसमें उल्लिखित प्रतिभूति देनी होती है। और जबकि परिवीक्षाधीन के अनुरोध पर, मैं, {!! $blank($sname, '200px') !!}
        (प्रतिभू का पूरा नाम), निवासी {!! $blank($saddr, '250px') !!} (निवास स्थान का पता), {!! $blank($socc, '160px') !!} (व्यवसाय) के रूप में
    ...
    <div class="lines">
        दिनांक {!! $blank($dated, '150px') !!}
        <div class="sign">परिवीक्षाधीन के हस्ताक्षर: {!! $blank('', '200px') !!}</div>
        <div>साक्षी की उपस्थिति में परिवीक्षाधीन द्वारा हस्ताक्षरित — साक्षी का नाम: {!! $blank($pwn, '200px') !!}</div>
        <div>पता: {!! $blank($pwa, '280px') !!} &nbsp; व्यवसाय: {!! $blank($pwo, '150px') !!}</div>

        <div class="sign">प्रतिभू के हस्ताक्षर: {!! $blank('', '200px') !!}</div>
        <div>साक्षी की उपस्थिति में प्रतिभू द्वारा हस्ताक्षरित — साक्षी का नाम: {!! $blank($swn, '200px') !!}</div>
        <div>पता: {!! $blank($swa, '280px') !!} &nbsp; व्यवसाय: {!! $blank($swo, '150px') !!}</div>
    </div>
