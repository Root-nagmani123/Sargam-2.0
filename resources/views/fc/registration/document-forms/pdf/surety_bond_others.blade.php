...
<body>
    ...
    <div class="lines">
        <div>(साक्षी का नाम) {!! $blank($hi['pwname'] ?? '', '180pt') !!} पता {!! $blank($hi['pwaddr'] ?? '', '250pt') !!} व्यवसाय {!! $blank($hi['pwocc'] ?? '', '150pt') !!} की उपस्थिति में <b>परिवीक्षाधीन द्वारा</b> हस्ताक्षर किए।</div>

        <div class="sign" style="text-align:center; margin-top:12pt;">प्रतिभू के हस्ताक्षर: {!! $blank('', '200pt') !!}</div>
        <div style="margin-top:10pt;">(साक्षी का नाम) {!! $blank($hi['swname'] ?? '', '180pt') !!} पता {!! $blank($hi['swaddr'] ?? '', '250pt') !!} व्यवसाय {!! $blank($hi['swocc'] ?? '', '150pt') !!} की उपस्थिति में <b>प्रतिभू द्वारा</b> हस्ताक्षर किए।</div>
    </div>
    ...
    <div class="lines">
        <div class="sign" style="text-align:center; margin-top:12pt;">प्रतिभू के हस्ताक्षर: {!! $blank('', '200pt') !!}</div>
        <div style="margin-top:10pt;">(साक्षी का नाम) {!! $blank($hi['swname2'] ?? '', '180pt') !!} पता {!! $blank($hi['swaddr2'] ?? '', '250pt') !!} व्यवसाय {!! $blank($hi['swocc2'] ?? '', '150pt') !!} की उपस्थिति में <b>प्रतिभू द्वारा</b> हस्ताक्षर किए।</div>
    </div>
