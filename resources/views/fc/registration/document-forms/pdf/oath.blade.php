...
<style>
    ...
    body { font-family: 'DejaVu Sans', sans-serif; font-size: 11pt; color: #000; line-height: 1.6; }
    .doc-title { text-align: center; font-weight: bold; font-size: 15pt; text-decoration: underline; }
    .doc-subtitle { text-align: center; font-weight: bold; font-size: 9.5pt; margin-top: 4pt; }
    .doc-body { text-align: justify; margin-top: 26pt; }
    .doc-god { text-align: center; font-weight: bold; margin-top: 20pt; }
    .lines { margin-top: 22pt; }
    .lines td { padding: 6pt 0; vertical-align: bottom; }
    .lbl { font-weight: bold; white-space: nowrap; padding-right: 8pt; width: 120pt; }
    .doc-place { margin-top: 26pt; }
    .doc-note { margin-top: 26pt; font-size: 11pt; }
    .doc-accepted { text-align: center; font-weight: bold; text-decoration: underline; margin-top: 30pt; }
    .sig-img { max-height: 40pt; max-width: 200pt; }
</style>
</head>
<body>
    ...
    <div style="margin-top:10pt;">Dated {!! $blank($dated, '170pt') !!}</div>
    ...
    <div class="doc-body">
        &ldquo;मैं {!! $blank($hi['name'] ?? '', '250pt') !!} (परिवीक्षाधीन का नाम) शपथ लेता/लेती हूँ/सत्यनिष्ठा से
    ...
    <div style="margin-top:10pt;">दिनांक {!! $blank($hi['date'] ?? '', '170pt') !!}</div>
