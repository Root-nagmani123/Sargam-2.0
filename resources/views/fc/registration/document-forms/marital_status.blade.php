            ...
            <div class="ms-doc">
                ...
                <div class="ms-sign">
                    <div style="display:flex; justify-content:space-between; flex-wrap:wrap; gap:.5rem;">
                        <span>दिनांक / Date: <input type="date" name="declaration_date" class="blank blank--sm" value="{{ $val('declaration_date') }}"></span>
                    ...
                    <div style="display:flex; justify-content:space-between; flex-wrap:wrap; gap:.5rem; margin-top:.4rem;">
                        <span>स्थान / Place: <input type="text" name="place" class="blank" value="{{ old('place', $data['place'] ?? 'Mussoorie') }}"></span>
