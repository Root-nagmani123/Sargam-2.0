        ...
        <div class="sb-paper">
            ...
            <div class="sb-doc" lang="hi">
                ...
                <p class="sb-body" style="text-indent:0; margin-top:1.4rem;">
                    ...
                    <span class="d-block mt-1">(क) मैं <input type="text" name="hi[govt]" class="blank blank--mid" value="{{ $data['_hi']['govt'] ?? '' }}" autocomplete="off"> सरकार की स्थायी सेवा में हूँ; <b>अथवा</b></span>
