            ...
            <div class="col-md-8 col-lg-9">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3-tab">
                        <!-- Personal Details -->
                         <div class="mb-3">
                            <h5 class="card-title text-primary fw-bold" style="font-size: 24px;">Joining Documents</h5>
                                <p class="text-muted mb-4">Upload Documnet</p>
                         </div>
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-primary fw-bold mb-3" style="font-size: 20px;">Administration Section Related Documents</h5>
