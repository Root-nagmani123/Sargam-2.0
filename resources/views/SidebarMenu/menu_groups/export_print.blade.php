{{-- Print export for Sidebar Menu Groups.
     ...
     Chrome comes from the module partials, shared with the Categories export. --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <title>Sidebar Menu Groups — LBSNAA</title>
...
<body onload="window.print();">
    ...
    @include('SidebarMenu.partials.export_print_header', [
        'title' => 'Sidebar Menu Groups',
        'exportDate' => $exportDate,
        'filterLine' => $filterLine,
        'total' => $rows->count(),
    ])

    {{-- Columns come from MenuGroupService::exportColumnDefs(), already filtered
    ...
    <table class="sbm-print-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="{{ max(count($columns), 1) }}" class="sbm-print-empty">No menu groups to print</td>
                </tr>
            @endforelse
        </tbody>
    </table>
