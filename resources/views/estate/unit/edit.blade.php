...
<div class="container-fluid">
    <x-breadcrum title="Edit Unit" />
    <div class="card" style="border-left: 4px solid #004a93;">
        <div class="card-body">
            <h4 class="mb-3">Edit Unit</h4>
            <hr>
            <form action="{{ route('estate.unit.update', $unit->pk) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-4">
                            ...
                            <select class="form-select @error('estate_campus_master_pk') is-invalid @enderror" 
                                ...
                                @foreach($campuses as $campus)
                                    <option value="{{ $campus->pk }}" 
                                        {{ old('estate_campus_master_pk', $unit->estate_campus_master_pk) == $campus->pk ? 'selected' : '' }}>
                                        {{ $campus->campus_name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-select @error('estate_area_master_pk') is-invalid @enderror" 
                                ...
                                @foreach($areas as $area)
                                    <option value="{{ $area->pk }}" 
                                        {{ old('estate_area_master_pk', $unit->estate_area_master_pk) == $area->pk ? 'selected' : '' }}>
                                        {{ $area->area_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('estate_block_master_pk') is-invalid @enderror" 
                                ...
                                @foreach($blocks as $block)
                                    <option value="{{ $block->pk }}" 
                                        {{ old('estate_block_master_pk', $unit->estate_block_master_pk) == $block->pk ? 'selected' : '' }}>
                                        {{ $block->block_name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-select @error('estate_unit_type_master_pk') is-invalid @enderror" 
                                ...
                                @foreach($unitTypes as $unitType)
                                    <option value="{{ $unitType->pk }}" 
                                        {{ old('estate_unit_type_master_pk', $unit->estate_unit_type_master_pk) == $unitType->pk ? 'selected' : '' }}>
                                        {{ $unitType->unit_type }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('house_address') is-invalid @enderror" 
                                   id="house_address" name="house_address" value="{{ old('house_address', $unit->house_address) }}">
                            @error('house_address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('capacity') is-invalid @enderror" 
                                   id="capacity" name="capacity" value="{{ old('capacity', $unit->capacity) }}">
                            @error('capacity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('quantity') is-invalid @enderror" 
                                   id="quantity" name="quantity" value="{{ old('quantity', $unit->quantity) }}">
                            @error('quantity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('estate_value') is-invalid @enderror" 
                                   id="estate_value" name="estate_value" value="{{ old('estate_value', $unit->estate_value) }}">
                            @error('estate_value')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('rent') is-invalid @enderror" 
                                   id="rent" name="rent" value="{{ old('rent', $unit->rent) }}">
                            @error('rent')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="is_rent_applicable" 
                                   name="is_rent_applicable" value="1" {{ old('is_rent_applicable', $unit->is_rent_applicable) ? 'checked' : '' }}>
