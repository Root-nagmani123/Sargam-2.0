...
<div class="container-fluid">
    <x-breadcrum title="Add New Area" />
    <div class="card" style="border-left: 4px solid #004a93;">
        <div class="card-body">
            <h4 class="mb-3">Add New Area</h4>
            <hr>
            <form action="{{ route('estate.area.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('area_name') is-invalid @enderror" 
                                   id="area_name" name="area_name" value="{{ old('area_name') }}" required>
                            @error('area_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
