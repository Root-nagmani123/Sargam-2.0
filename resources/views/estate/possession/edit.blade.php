...
@section('title', 'Edit Possession')

@section('setup_content')
<div class="container-fluid">
    <x-breadcrum title="Edit Possession" />
    <div class="card" style="border-left: 4px solid #004a93;">
        <div class="card-body">
            <h4 class="mb-3">Edit Possession</h4>
            <hr>
            <form action="{{ route('estate.possession.update', $possession->pk) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <select class="form-select @error('employee_master_pk') is-invalid @enderror" 
                                ...
                                @foreach($employees as $employee)
                                    <option value="{{ $employee->id }}" 
                                        {{ old('employee_master_pk', $possession->employee_master_pk) == $employee->id ? 'selected' : '' }}>
                            ...
                            <select class="form-select @error('estate_unit_master_pk') is-invalid @enderror" 
                                ...
                                @foreach($units as $unit)
                                    <option value="{{ $unit->pk }}" 
                                        {{ old('estate_unit_master_pk', $possession->estate_unit_master_pk) == $unit->pk ? 'selected' : '' }}>
                                        {{ $unit->unit_name }} - {{ $unit->campus->campus_name ?? '' }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('possession_date') is-invalid @enderror" 
                                   id="possession_date" name="possession_date" 
                                   value="{{ old('possession_date', $possession->possession_date?->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('vacation_date') is-invalid @enderror" 
                                   id="vacation_date" name="vacation_date" 
                                   value="{{ old('vacation_date', $possession->vacation_date?->format('Y-m-d')) }}">
                            @error('vacation_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('licence_fee') is-invalid @enderror" 
                                   id="licence_fee" name="licence_fee" value="{{ old('licence_fee', $possession->licence_fee) }}">
                            @error('licence_fee')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('water_charge') is-invalid @enderror" 
                                   id="water_charge" name="water_charge" value="{{ old('water_charge', $possession->water_charge) }}">
                            @error('water_charge')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('meter_no_one') is-invalid @enderror" 
                                   id="meter_no_one" name="meter_no_one" value="{{ old('meter_no_one', $possession->meter_no_one) }}">
                            @error('meter_no_one')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('initial_reading_one') is-invalid @enderror" 
                                   id="initial_reading_one" name="initial_reading_one" value="{{ old('initial_reading_one', $possession->initial_reading_one) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('meter_no_two') is-invalid @enderror" 
                                   id="meter_no_two" name="meter_no_two" value="{{ old('meter_no_two', $possession->meter_no_two) }}">
                            @error('meter_no_two')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('initial_reading_two') is-invalid @enderror" 
                                   id="initial_reading_two" name="initial_reading_two" value="{{ old('initial_reading_two', $possession->initial_reading_two) }}">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('remarks') is-invalid @enderror" 
                                      id="remarks" name="remarks" rows="3">{{ old('remarks', $possession->remarks) }}</textarea>
                            @error('remarks')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
