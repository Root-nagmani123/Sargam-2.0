<nav class="sidebar-nav sargam-menu-flyout simplebar-scrollable-y" id="menu-right-setup-mini-6" data-mini-nav-target="setup-mini-6" data-simplebar="init">
                        ...
                        <ul class="sidebar-menu list-unstyled" id="sidebarnav">
                            ...
                            <ul class="collapse list-unstyled" id="employeeCollapse">
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('member.index') }}">
                                        <span class="hide-menu">Employee Master</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('master.employee.type.index') }}">
                                        <span class="hide-menu">Employee Type</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('master.employee.group.index') }}">
                                        <span class="hide-menu">Employee Group</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('master.department.master.index') }}">
                                        <span class="hide-menu">Department Master</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('master.designation.index') }}">
                                        <span class="hide-menu">Designation Master</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('master.caste.category.index') }}">
                            ...
                            <ul class="collapse list-unstyled" id="facultyCollapse">
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1 {{ request()->routeIs('master.appellation.*') ? 'active' : '' }}"
                                        href="{{ route('master.appellation.index') }}">
                                        <span class="hide-menu">Appellation Master</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('master.faculty.expertise.index') }}">
                                        <span class="hide-menu">Faculty Expertise</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('master.faculty.type.master.index') }}">
                                        <span class="hide-menu">Faculty Type</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('faculty.index') }}">
                                        <span class="hide-menu">Faculty</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1 {{ request()->routeIs('admin.faculty.whos-who') ? 'active' : '' }}"
                            ...
                            <ul class="collapse list-unstyled" id="userManagementCollapse">
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.roles.index') }}">
                                        <span class="hide-menu">Roles</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.users.index') }}">
                            ...
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.setup.quick_links.index') }}">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">link</i>
                                    <span class="hide-menu">Quick Links Master</span>
                                </a>
                            </li>
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.setup.useful_links.index') }}">
                            ...
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('course-repository.index') }}">
