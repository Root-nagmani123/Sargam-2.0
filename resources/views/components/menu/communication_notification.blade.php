<nav class="sidebar-nav sargam-menu-flyout simplebar-scrollable-y" id="menu-right-mini-13" data-mini-nav-target="mini-13" data-simplebar="init">
                        ...
                        <ul class="sidebar-menu list-unstyled" id="sidebarnav">
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="#" id="get-url" aria-expanded="false">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">campaign</i>
                                    <span class="hide-menu">Notice</span>
                                </a>
                            </li>
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="#" aria-expanded="false">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">chat</i>
                                    <span class="hide-menu">Start Conversation</span>
                                </a>
                            </li>
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="#" aria-expanded="false">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">mark_chat_read</i>
                                    <span class="hide-menu">View Sent Conversation</span>
                                </a>
                            </li>
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="#" aria-expanded="false">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">forum</i>
                                    <span class="hide-menu">Campus Tweet</span>
                                </a>
                            </li>
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="#" aria-expanded="false">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">announcement</i>
                                    <span class="hide-menu">Announcement</span>
                                </a>
                            </li>
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="#" aria-expanded="false">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">settings_suggest</i>
                            ...
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="#" aria-expanded="false">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">mark_chat_unread</i>
                                    <span class="hide-menu">View Closed Conversation</span>
                                </a>
                            </li>
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="#" aria-expanded="false">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">forward_to_inbox</i>
