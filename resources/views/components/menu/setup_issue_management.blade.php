<nav class="sidebar-nav sargam-menu-flyout simplebar-scrollable-y" id="menu-right-mini-10" data-mini-nav-target="mini-10" data-simplebar="init">
                    ...
                    <div class="simplebar-content">
                        ...
                        <ul class="sidebar-menu list-unstyled mb-0" id="sidebarnav">
                            ...
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.issue-management.index') }}">
                                    <i class="material-icons material-symbols-rounded" style="font-size:20px;">list_alt</i>
                                    <span class="hide-menu">All Issues</span>
                                </a>
                            </li>
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.issue-management.centcom') }}">
                            ...
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.issue-management.create') }}">
                            ...
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.issue-categories.index') }}">
                            ...
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.issue-sub-categories.index') }}">
                            ...
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.issue-priorities.index') }}">
                            ...
                            <li class="sidebar-item mb-1">
                                <a class="sidebar-link d-flex align-items-center gap-1" href="{{ route('admin.issue-escalation-matrix.index') }}">
