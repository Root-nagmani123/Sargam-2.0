                        ...
                        <ul class="sidebar-menu list-unstyled" id="sidebarnav">
                            ...
                            <ul class="collapse list-unstyled" id="generalMasterMenu">
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('Venue-Master.index') }}">
                                        <span class="hide-menu">Venue Master</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('master.class.session.index') }}">
                                        <span class="hide-menu">Class Session</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('stream.index') }}">
                            ...
                            <ul class="collapse list-unstyled" id="hostelMenu">
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('master.hostel.building.index') }}">
                                        <span class="hide-menu">Building Master</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('master.hostel.floor.index') }}">
                                        <span class="hide-menu">Floor</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('hostel.building.floor.room.map.index') }}">
                                        <span class="hide-menu">Building Floor Room Mapping</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('hostel.building.map.assign.student') }}">
                            ...
                            <ul class="collapse list-unstyled" id="addressMenu">
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('master.country.index') }}">
                                        <span class="hide-menu">Country</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('master.state.index') }}">
                                        <span class="hide-menu">State</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('master.district.index') }}">
                                        <span class="hide-menu">District</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('master.city.index') }}">
