<nav class="sidebar-nav d-block simplebar-scrollable-y" id="menu-right-mini-1" data-simplebar="init">
    ...
    min-width: 250px;">
                            ...
                            <ul class="collapse list-unstyled ps-3" id="generalCollapse">
                                ...
                                <li class="sidebar-item"><a class="sidebar-link"
                                        ...
                                        <span class="hide-menu">Notice notification</span>
                                    </a></li>
                            </ul>
    ...
    min-width: 250px;">
                            ...
                            <ul class="collapse list-unstyled ps-3" id="courseCollapse">
                                ...
                                <li class="sidebar-item"><a class="sidebar-link"
                                        href="{{ route('subject-module.index') }}"><span class="hide-menu">Subject
                                            Module Master</span>
                                    </a></li>
                            </ul>
    ...
    min-width: 250px;">
                            ...
                            <ul class="collapse list-unstyled ps-3" id="exemptionCollapse">
                                ...
                                <li class="sidebar-item"><a class="sidebar-link"
                                        ...
                                        <span class="hide-menu">Medical Exception Faculty View</span>
                                    </a></li>
                                    
                                    @if(hasRole('Student-OT'))
                                <li class="sidebar-item"><a class="sidebar-link"
                                        href="{{ route('medical.exception.ot.view') }}">
                                        <span class="hide-menu">Medical Exception OT View</span>
                                    </a></li>
                                    @endif
                            </ul>
