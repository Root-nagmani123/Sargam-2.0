<nav class="sidebar-nav d-block simplebar-scrollable-y" id="menu-right-setup-mini-4" data-simplebar="init">
                    ...
                    <div class="simplebar-content" style="padding: 20px 0px 24px 20px;">
                        ...
                        <ul class="sidebar-menu list-unstyled" id="sidebarnav">
                            ...
                            <ul class="collapse list-unstyled" id="memoCollapse">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('master.discipline.index') }}">
                            ...
                            <ul class="collapse list-unstyled" id="reportCollapse">
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('admin.feedback.feedback_details') }}">
                                        <span class="hide-menu">Faculty Feedback with OT Details</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('admin.feedback.faculty_view') }}">
                                        <span class="hide-menu">Faculty Feedback with Comments</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('feedback.average') }}">
                                        <span class="hide-menu">Faculty Feedback Average</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('admin.feedback.database') }}">
                                        <span class="hide-menu">Faculty Feedback Database</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('admin.feedback.pending.students') }}">
                        ...
                        <ul class="collapse list-unstyled" id="otCollapse">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('peer.user_groups') }}">
                                    <span class="hide-menu">Peer Evaluation</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link d-flex align-items-center gap-2" href="{{ route('admin.course-repository.user.index') }}">
