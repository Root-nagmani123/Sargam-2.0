...
@push('styles')
<link rel="stylesheet"
    href="{{ asset('css/vendor-master-admin.css') }}?v={{ @filemtime(public_path('css/vendor-master-admin.css')) ?: time() }}">
@endpush
...
<div class="container-fluid vnd-master-page py-4">
    ...
    <div class="card vnd-dt-card border-0 shadow-sm rounded-3 overflow-hidden">
        <div class="card-body p-3 p-md-4">
            <div
                class="programme-dt-toolbar vnd-dt-toolbar d-flex flex-wrap align-items-center justify-content-end gap-2 gap-md-3 mb-4">
                        ...
                        <tbody>
                            ...
                            <tr class="{{ $loop->odd ? 'odd' : 'even' }}">
                                ...
                                <td class="vnd-status-cell">
                                    <span
                                        class="badge rounded-pill programme-status-badge vnd-status-badge programme-status-badge--{{ $isVendorActive($vendor) ? 'active' : 'inactive' }}">
                                        {{ $isVendorActive($vendor) ? 'Active' : 'Inactive' }}
                                    </span>
                                </td>
                                <td class="vnd-action-cell">
                                    <div class="vnd-vendor-actions d-inline-flex align-items-center gap-2 programme-action-group"
                                        role="group" aria-label="Vendor actions">
                                        <button type="button" class="btn-view-vendor programme-action-btn"
                                            ...
                                            aria-label="View vendor" title="View vendor">
                                            <i class="bi bi-eye" aria-hidden="true"></i>
                                        </button>
                                        <button type="button" class="btn-edit-vendor programme-action-btn"
                                            data-id="{{ $vendor->id }}" data-name="{{ e($vendor->name) }}"
                                            data-email="{{ e($vendor->email ?? '') }}"
                                            data-contact-person="{{ e($vendor->contact_person ?? '') }}"
                                            data-phone="{{ e($vendor->phone ?? '') }}"
                                            ...
                                            data-ifsc-code="{{ e($vendor->ifsc_code ?? '') }}"
                                            data-account-number="{{ e($vendor->account_number ?? '') }}"
                                            data-status="{{ e($vendor->status ?? 'active') }}" aria-label="Edit vendor"
                                            title="Edit vendor">
                                            <i class="bi bi-pencil" aria-hidden="true"></i>
                                        </button>
                                        <div class="form-check form-switch vnd-action-switch-wrap mb-0">
                                            <input class="form-check-input status-toggle" type="checkbox" role="switch"
                                                data-table="mess_vendors" data-column="status"
                                                data-id="{{ $vendor->id }}" data-id_column="id"
                                        ...
                                        <button type="button"
                                            ...
                                            disabled aria-disabled="true" title="Cannot delete active vendor"
                                        ...
                                        <form method="POST"
                                            ...
                                            <button type="submit"
                                                class="vnd-delete-btn programme-action-btn programme-action-btn--danger"
                                                aria-label="Delete vendor" title="Delete vendor">
                                                <i class="bi bi-trash" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                        @else
                            ...
                            <tr class="vnd-empty-row">
                                <td colspan="8" class="vnd-empty-state text-center">
                                    <i class="bi bi-truck display-4 text-secondary opacity-50 d-block mb-3"
                                        aria-hidden="true"></i>
...
<div class="modal fade" id="editVendorModal" tabindex="-1" aria-labelledby="editVendorModalLabel" aria-hidden="true"
    data-bs-backdrop="static">
    <div
        class="modal-dialog modal-dialog-centered modal-dialog-scrollable vnd-vendor-modal-dialog vnd-vendor-modal-dialog--xl">
        <div class="modal-content cgt-form-modal border-0 shadow-lg rounded-4 vnd-modal-form">
            <form id="editVendorForm" method="POST"
                action="{{ $openEditModal && old('vendor_modal_id') ? route('admin.mess.vendors.update', old('vendor_modal_id')) : '' }}"
                enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" name="vendor_modal_id" id="edit_vendor_modal_id"
                    value="{{ old('vendor_modal_id', $editVendor?->id ?? '') }}">
                <div class="modal-header border-0 pb-0">
                ...
                <div class="modal-body pt-3">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" id="edit_vendor_name" class="form-control form-control-sm"
                                required pattern="[a-zA-Z0-9\s\-]+" maxlength="255" autocomplete="off">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="contact_person" id="edit_vendor_contact_person"
                                ...
                                autocomplete="off">
                            <div class="text-danger small mt-1" id="edit_vendor_contact_person_error" role="alert">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label fw-medium">Phone <span class="text-danger">*</span></label>
                            <input type="text" name="phone" id="edit_vendor_phone" class="form-control form-control-sm"
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="address" id="edit_vendor_address" class="form-control form-control-sm"
                                rows="3" required maxlength="2000" autocomplete="off"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="bank_name" id="edit_vendor_bank_name"
                                class="form-control form-control-sm" maxlength="255" pattern="[a-zA-Z0-9\s\-]+"
                                placeholder="No special characters, max 255">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="ifsc_code" id="edit_vendor_ifsc_code"
                                ...
                                pattern="[A-Za-z0-9]+" placeholder="Letters & numbers, max 11">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select name="status" id="edit_vendor_status" class="form-select rounded-3">
                                <option value="active"
                                    {{ old('status', $editVendor->status ?? 'active') === 'active' ? 'selected' : '' }}>
                                    Active</option>
                                <option value="inactive"
                                    {{ old('status', $editVendor->status ?? '') === 'inactive' ? 'selected' : '' }}>
                                    Inactive</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-6">
    ...
    function initVendorPage() {
        ...
        if (editForm) {
            editForm.addEventListener('submit', function(e) {
                ...
                showLiveError(document.getElementById('edit_vendor_name'), document.getElementById(
                    'edit_vendor_name_error'), r1);
                showLiveError(document.getElementById('edit_vendor_contact_person'), document
                    .getElementById('edit_vendor_contact_person_error'), r2);
                showLiveError(document.getElementById('edit_vendor_address'), document.getElementById(
                    'edit_vendor_address_error'), r3);
                if (!r1.valid || !r2.valid || !r3.valid || !r4.valid || !rOpt) {
                    e.preventDefault();
                    return;
                }
        ...
        @if($openEditModal)
            (function() {
                ...
                if (editId && editId.value) {
                    document.getElementById('editVendorForm').action = vendorsDestroyBaseUrl + '/' + editId
                        .value;
                }
                showVendorModal('editVendorModal');
            })();
