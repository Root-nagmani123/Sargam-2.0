@php
    ...
    $reportTitle = $reportTitle ?? 'Selling Voucher';
    ...
    $headingClassMap = [
        ...
        'Item Qty'            => 'col-qty',
        'Return Qty'          => 'col-qty',
        'Transfer From Store' => 'col-store',
        'Client Type'         => 'col-ctype',
        'Client Name'         => 'col-cname',
        'Payment'             => 'col-pay',
        'Request Date'        => 'col-date',
        'Status'              => 'col-status',
    ];
    $centerHeadings = ['S.No.', 'Item Qty', 'Return Qty', 'Payment', 'Request Date', 'Status'];
@endphp
<!doctype html>
<html lang="en">
<head>
