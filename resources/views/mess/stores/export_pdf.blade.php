@php
    ...
    $reportTitle = $reportTitle ?? 'Store Master';
    ...
    // Per-column width tuning (by heading), so long names/locations get room.
    $headingClassMap = [
        'S.No.'      => 'col-sno',
        'Store Name' => 'col-name',
        'Store Type' => 'col-type',
    ...
    $centerHeadings = ['S.No.', 'Store Type', 'Status'];
@endphp
<!doctype html>
<html lang="en">
<head>
