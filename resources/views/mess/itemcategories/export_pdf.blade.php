@php
    ...
    $reportTitle = $reportTitle ?? 'Category Item Master';
    ...
    // Per-column width tuning (by heading).
    $headingClassMap = [
        'S.No.'                     => 'col-sno',
        'Category Name'             => 'col-name',
        'Category Type'             => 'col-type',
        'Item Category Description' => 'col-desc',
        'Status'                    => 'col-status',
    ];
    $centerHeadings = ['S.No.', 'Category Type', 'Status'];
@endphp
<!doctype html>
<html lang="en">
<head>
