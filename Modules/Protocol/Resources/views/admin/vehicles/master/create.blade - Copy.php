    ...
    <div class="card-clean p-3">
        ...
        <div class="form-header">
            <div>
                ...
                <p>
                    Please add the vehicle details in the form below
                </p>
            </div>
        </div>
        ...
        <form
            id="vehicleForm"
            method="POST"
            action="{{ route('protocol.vehicle-master.store') }}"
            novalidate
        >
            ...
            <div class="form-section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input
                                type="number"
                                name="average_committed"
                                class="form-control"
                                value="{{ old('average_committed') }}"
                                min="0"
                                step="0.01"
                                placeholder="0.00"
                            >
                ...
                {{-- Manufacture Year / Maintained By --}}
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            name="vehicle_part"
                            class="form-control"
                            value="{{ old('vehicle_part') }}"
                            placeholder="Enter vehicle part"
                        >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            name="validity_km"
                            class="form-control"
                            value="{{ old('validity_km') }}"
                            min="0"
                            step="0.01"
                            placeholder="Enter validity in KM"
                        >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input
                                type="number"
                                name="total_vehicle_cost"
                                class="form-control"
                                value="{{ old('total_vehicle_cost') }}"
                                min="0"
                                step="0.01"
                                placeholder="0.00"
                            >
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input
                                type="number"
                                name="actual_vehicle_cost"
                                class="form-control"
                                value="{{ old('actual_vehicle_cost') }}"
                                min="0"
                                step="0.01"
                                placeholder="0.00"
                            >
                        ...
                        <div class="radio-group">
                            ...
                            <div class="form-check">
                                ...
                                <input
                                    ...
                                    value="purchase"
                                    id="purchase"
                                    @checked(old('purchase_type', 'purchase') === 'purchase')
                                >
                            ...
                            <div class="form-check">
                                ...
                                <input
                                    ...
                                    value="rent"
                                    id="rent"
                                    @checked(old('purchase_type') === 'rent')
                                >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            class="form-control"
                            value="{{ old('last_installment_date') }}"
                        >
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea
                            ...
                            class="form-control"
                            rows="3"
                            placeholder="Enter purchase or rental notes"
                        >{{ old('purchase_notes') }}</textarea>
            ...
            <div class="form-section">
                ...
                <div class="section-title">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <input
                            ...
                            @checked(old('has_insurance'))
                        >

                        <label
                            for="insuranceCheckbox"
                            class="mb-0"
                        >
                ...
                <div
                    id="insuranceContent"
                    style="{{ old('has_insurance') ? '' : 'display:none;' }}"
                >
            ...
            <div class="button-group">
                ...
                <a
                    href="{{ route('protocol.vehicle-master.index') }}"
...
<script>
    window.driverMasterUrls = {
        ...
        // Old values are required by the AJAX dropdown
...
<script>
    $(document).ready(function () {
        ...
        @if(old('manufacture_year'))
            yearSelect.val('{{ old('manufacture_year') }}');
        @endif


        // Insurance section
        $('#insuranceCheckbox').on('change', function () {
...
$(document).ready(function () {
    ...
    */
    ...
    const oldManufactureYear = @json(
        old('manufacture_year', '')
    );
    ...
    */
    ...
    function toggleInsurance() {
        ...
        if ($('#insuranceCheckbox').is(':checked')) {
            ...
            /*
             * Remove validation errors when insurance is disabled.
             */
    ...
    $('#vehicleForm').validate({
        ...
        messages: {
            ...
            vehicle_number: {
                ...
                maxlength: 'Vehicle number cannot exceed 255 characters.'
            },

            manufacturer: {
                required: 'Please enter manufacturer.',
                maxlength: 'Manufacturer cannot exceed 255 characters.'
            },

            engine_number: {
                required: 'Please enter engine number.',
                maxlength: 'Engine number cannot exceed 255 characters.'
            },

            chassis_number: {
                required: 'Please enter chassis number.',
                maxlength: 'Chassis number cannot exceed 255 characters.'
            },
            ...
            current_reading: {
                ...
                number: 'Please enter a valid reading.',
                min: 'Reading cannot be negative.'
            },
            ...
            capacity: {
                ...
                digits: 'Capacity must be a whole number.',
                min: 'Capacity must be at least 1.'
            },

            maintained_by: {
                required: 'Please enter maintained by.'
            },
            ...
            registration_authority: {
                required: 'Please enter registration authority.'
            },

            validity_years: {
                required: 'Please enter validity in years.',
                digits: 'Validity years must be a whole number.',
                min: 'Validity years cannot be negative.'
            },

            purchase_type: {
                required: 'Please select purchase or rental.'
            }
        },
        ...
        */
        ...
        submitHandler: function (form) {
            ...
            /*
             * Add conditional rules only when insurance is selected.
             */

            if ($('#insuranceCheckbox').is(':checked')) {

                $('input[name="insurer_name"]').rules(
                    'add',
                    {
                        required: true,
                        messages: {
                ...
                $('input[name="insurance_company_name"]').rules(
                    'add',
                    {
                        required: true,
                        messages: {
                ...
                $('input[name="insurance_date"]').rules(
                    'add',
                    {
                        required: true,
                        messages: {
                ...
                $('input[name="insurance_expiry_date"]').rules(
                    'add',
                    {
                        required: true,
                        messages: {
                ...
                $('input[name="premium_amount"]').rules(
                    'add',
                    {
                        required: true,
                        number: true,
                        ...
                        messages: {
                            ...
                            number: 'Please enter a valid premium amount.',
                            min: 'Premium amount cannot be negative.'
                        }
                    }
                );
                 ...
                 * Remove conditional rules if checkbox is unchecked.
                 */
            ...
            /*
             * Validate again after adding conditional rules.
             */
