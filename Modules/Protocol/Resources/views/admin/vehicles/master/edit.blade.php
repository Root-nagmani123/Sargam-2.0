...
@section('page_subtitle', 'Update vehicle details')
...
<div class="container-fluid profile-page">
    ...
    <div class="card-clean p-3">
        ...
        <div class="form-header">
            <div>
                <h2><i class="fas fa-car"></i> Update Vehicle Information</h2>
                <p>Please update the vehicle details in the form below</p>
            </div>
        </div>

        <form id="vehicleForm" method="POST" action="{{ route('protocol.vehicle-master.update', $vehicle->id) }}" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="vehicle_name" class="form-control" value="{{ old('vehicle_name', $vehicle->vehicle_name) }}" placeholder="Enter vehicle name">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label required">Vehicle Number</label>
                        <input type="text" name="vehicle_number" class="form-control" value="{{ old('vehicle_number', $vehicle->vehicle_number) }}" placeholder="Enter vehicle number">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="manufacturer" class="form-control" value="{{ old('manufacturer', $vehicle->manufacturer) }}" placeholder="Enter manufacturer">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="model" class="form-control" value="{{ old('model', $vehicle->model) }}" placeholder="Enter vehicle model">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="average_committed" class="form-control" value="{{ old('average_committed', $vehicle->average_committed) }}" min="0" step="0.01" placeholder="0.00">
                            <span class="input-group-text">km/L</span>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label required">Current Reading</label>
                        <input type="number" name="current_reading" class="form-control" value="{{ old('current_reading', $vehicle->current_reading) }}" min="0" step="0.01" placeholder="Enter odometer reading">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="capacity" class="form-control" value="{{ old('capacity', $vehicle->capacity) }}" min="1" step="1" placeholder="Enter capacity">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="radio-group">
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="status" value="1" id="statusActive" @checked(old('status', (string) (int) $vehicle->status) === '1')>
                                <label class="form-check-label" for="statusActive">Active</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="status" value="0" id="statusInactive" @checked(old('status', (string) (int) $vehicle->status) === '0')>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="maintained_by" class="form-control" value="{{ old('maintained_by', $vehicle->maintained_by) }}" placeholder="Enter maintained by">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="registration_number" class="form-control" value="{{ old('registration_number', $vehicle->registration_number) }}" placeholder="Enter registration number">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="registration_authority" class="form-control" value="{{ old('registration_authority', $vehicle->registration_authority) }}" placeholder="Enter registration authority">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="vehicle_part" class="form-control" value="{{ old('vehicle_part', $vehicle->vehicle_part) }}" placeholder="Enter vehicle part">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="vehicle_notes" class="form-control" rows="3" placeholder="Enter vehicle notes">{{ old('vehicle_notes', $vehicle->vehicle_notes) }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="validity_km" class="form-control" value="{{ old('validity_km', $vehicle->validity_km) }}" min="0" step="0.01" placeholder="Enter validity in KM">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label required">Validity in Year(s)</label>
                        <input type="number" name="validity_years" class="form-control" value="{{ old('validity_years', $vehicle->validity_years) }}" min="0" step="1" placeholder="Enter validity in years">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="owned_by" class="form-control" value="{{ old('owned_by', $vehicle->owned_by) }}" placeholder="Enter owner name">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Financed By</label>
                        <input type="text" name="financed_by" class="form-control" value="{{ old('financed_by', $vehicle->financed_by) }}" placeholder="Enter finance company">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="total_vehicle_cost" class="form-control" value="{{ old('total_vehicle_cost', $vehicle->total_vehicle_cost) }}" min="0" step="0.01" placeholder="0.00">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">₹</span>
                            <input type="number" name="actual_vehicle_cost" class="form-control" value="{{ old('actual_vehicle_cost', $vehicle->actual_vehicle_cost) }}" min="0" step="0.01" placeholder="0.00">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="radio-group">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="purchase_type" value="purchase" id="purchase" @checked(old('purchase_type', $vehicle->purchase_type) === 'purchase')>
                                <label class="form-check-label" for="purchase">Purchase</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="purchase_type" value="rent" id="rent" @checked(old('purchase_type', $vehicle->purchase_type) === 'rent')>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="purchase_date" class="form-control" value="{{ old('purchase_date', optional($vehicle->purchase_date)->format('Y-m-d')) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">₹</span>
                            <input type="number" name="purchase_cost" class="form-control" value="{{ old('purchase_cost', $vehicle->purchase_cost) }}" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">₹</span>
                            <input type="number" name="margin_money" class="form-control" value="{{ old('margin_money', $vehicle->margin_money) }}" min="0" step="0.01">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">₹</span>
                            <input type="number" name="loan_amount" class="form-control" value="{{ old('loan_amount', $vehicle->loan_amount) }}" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">₹</span>
                            <input type="number" name="emi" class="form-control" value="{{ old('emi', $vehicle->emi) }}" min="0" step="0.01">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="rate_of_interest" class="form-control" value="{{ old('rate_of_interest', $vehicle->rate_of_interest) }}" min="0" max="100" step="0.01">
                            <span class="input-group-text">%</span>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">First Installment Date</label>
                        <input type="date" name="first_installment_date" class="form-control" value="{{ old('first_installment_date', optional($vehicle->first_installment_date)->format('Y-m-d')) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="last_installment_date" class="form-control" value="{{ old('last_installment_date', optional($vehicle->last_installment_date)->format('Y-m-d')) }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Vendor Name</label>
                        <input type="text" name="vendor_name" class="form-control" value="{{ old('vendor_name', $vehicle->vendor_name) }}" placeholder="Enter vendor name">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="purchase_notes" class="form-control" rows="3" placeholder="Enter purchase or rental notes">{{ old('purchase_notes', $vehicle->purchase_notes) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                <div class="section-title">
                    <div class="d-flex align-items-center gap-2">
                        <input type="checkbox" name="has_insurance" value="1" id="insuranceCheckbox" class="form-check-input m-0" @checked(old('has_insurance', $vehicle->has_insurance))>
                        <label for="insuranceCheckbox" class="mb-0"><i class="fas fa-shield-alt"></i> Vehicle Insurance Information</label>
                    </div>
                </div>

                <div id="insuranceContent" style="{{ old('has_insurance', $vehicle->has_insurance) ? '' : 'display:none;' }}">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Insurer Name</label>
                            <input type="text" name="insurer_name" class="form-control" value="{{ old('insurer_name', $vehicle->insurer_name) }}" placeholder="Enter insurer name">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Insurance Company Name</label>
                            <input type="text" name="insurance_company_name" class="form-control" value="{{ old('insurance_company_name', $vehicle->insurance_company_name) }}" placeholder="Enter insurance company name">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="insurance_date" class="form-control" value="{{ old('insurance_date', optional($vehicle->insurance_date)->format('Y-m-d')) }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Insurance Expiry Date</label>
                            <input type="date" name="insurance_expiry_date" class="form-control" value="{{ old('insurance_expiry_date', optional($vehicle->insurance_expiry_date)->format('Y-m-d')) }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">₹</span>
                                <input type="number" name="premium_amount" class="form-control" value="{{ old('premium_amount', $vehicle->premium_amount) }}" min="0" step="0.01" placeholder="0.00">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="insurance_notes" class="form-control" rows="3" placeholder="Enter insurance notes">{{ old('insurance_notes', $vehicle->insurance_notes) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    window.driverMasterOldValues = {
        country_id: "{{ old('country_id', $vehicle->country_id) }}",
        state_id: "{{ old('state_id', $vehicle->state_id) }}",
        city_id: "{{ old('city_id', $vehicle->city_id) }}"
    };
</script>
...
$(document).ready(function () {
    ...
    const oldManufactureYear = @json(old('manufacture_year', $vehicle->manufacture_year));
