...
@section('page_title', 'Create New Driver')
@section('page_subtitle', 'Add new driver')
        ...
        <div class="card-clean p-3">
            ...
            <div class="container">
                ...
                <div class="form-header">
                    ...
                    <p>
                        Please add the driver's personal and employment information
                    </p>
                </div>
                ...
                <form
                    id="driverForm"
                    method="POST"
                    action="{{ route('protocol.driver-master.store') }}"
                >
                    ...
                    <div class="form-section border rounded p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                >{{ old('note_about_driver') }}</textarea>
