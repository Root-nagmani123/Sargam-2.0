...
(function ($, window) {
  ...
  function parseBoolAttr(value) {
    ...
    function resolveSlot($table, tableId, kind, createIfMissing) {
        ...
        var $scope = $table.closest('.programme-dt-panel, .card-body, .datatables, .gm-dt-card, .cgt-dt-card, .ems-dt-card, .eccm-dt-card, .mdt-dt-card, .mmt-dt-card, .mcm-dt-card, .cmdm-dt-card, .dmc-dt-card');
        if ($scope.length) {
