...
const AdminSettings = {
  ...
  // Theme Dark or Light - respects user preference, color themes work in both modes
  ManageDarkThemeLayout() {
    ...
    const setTheme = (t) => {
      ...
      try { localStorage.setItem("bsTheme", t); } catch (e) {}
      const themeLayoutElement = document.getElementById(`${t}-layout`);
  ...
  // Theme Color - works in both light and dark mode
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Theme mode Dark or Light - persists to localStorage, color themes work in both modes
  function handleTheme() {
    ...
    document.querySelectorAll(".dark-layout").forEach((element) => {
      element.addEventListener("click", () => setThemeAttributes("dark"));
    });

    document.querySelectorAll(".light-layout").forEach((element) => {
      element.addEventListener("click", () => setThemeAttributes("light"));
    });
  }
  handleTheme();

  // Color theme (Blue_Theme, Aqua_Theme, etc.) - persists to localStorage, works in light and dark mode
  const colorThemeIds = ["Blue_Theme", "Aqua_Theme", "Purple_Theme", "Green_Theme", "Cyan_Theme", "Orange_Theme"];
    ...
    if (el) {
      el.addEventListener("change", function () {
        if (this.checked) {
          ...
          try { localStorage.setItem("bsColorTheme", id); } catch (e) {}
        }
      });
    }
  });
