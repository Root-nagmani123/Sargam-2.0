...
const AdminSettings = {
  ...
  // Theme Dark or Light - Always forced to light mode
  ManageDarkThemeLayout() {
    // Force light theme regardless of settings or system preference
    ...
    // Always force light mode - ignore system preference and settings
  ...
  function handleSidebar() {
    document.querySelectorAll(".sidebartoggler").forEach((element) => {
      element.addEventListener("click", function () {
        ...
        let nextType = "full";
        if (dataTheme === "full") {
          nextType = "mini-sidebar";
        }
        document.body.setAttribute("data-sidebartype", nextType);
        try {
          localStorage.setItem("SidebarType", nextType);
        } catch (e) {}
      });
    });
  }
