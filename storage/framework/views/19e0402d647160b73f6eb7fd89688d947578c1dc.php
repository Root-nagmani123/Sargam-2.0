    ...
    <div class="with-vertical">
        ...
        <nav class="navbar navbar-expand-lg p-0">
            ...
            <div class="d-block d-lg-none py-9 py-xl-0">
                <img src="<?php echo e(asset('admin_assets/images/logos/logo.svg')); ?>" alt="matdash-img">
            </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="javascript:void(0)" id="drop1" aria-expanded="false">
                                <div class="d-flex align-items-center gap-2 lh-base">
                                    <img src="<?php echo e(asset('admin_assets/images/profile/user-1.jpg')); ?>" class="rounded-circle" width="35"
                            ...
                            <div class="dropdown-menu profile-dropdown dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="position-relative px-4 pt-3 pb-2">
                                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom gap-6">
                                        <img src="<?php echo e(asset('admin_assets/images/profile/user-1.jpg')); ?>" class="rounded-circle" width="56"
...
<!--  Header End --><?php /**PATH C:\xampp1\htdocs\Sargam-2.0\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>