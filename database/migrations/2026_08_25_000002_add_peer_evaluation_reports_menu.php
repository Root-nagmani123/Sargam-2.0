...
/**
 * Adds the "Evaluation Reports" sidebar link under Peer Evaluation
...
{
    private string $route = 'admin/peer/reports';
    private string $permissionName = 'peer_evaluation_reports';
    private string $menuName = 'Evaluation Reports';
