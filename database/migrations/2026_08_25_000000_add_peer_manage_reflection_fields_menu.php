...
/**
 * Adds the "Manage Reflection Fields" sidebar link under Peer Evaluation
...
{
    private string $route = 'admin/peer/reflection-fields';
    private string $permissionName = 'peer_manage_reflection_fields';
    private string $menuName = 'Manage Reflection Fields';
