...
/**
 * Adds "Define Club/ Society Role" alongside "Define Club/ Society" in the
...
{
    private string $route          = 'master/club-society-role';
    private string $permissionName = 'define_club_society_role';
    private string $menuName       = 'Define Club/ Society Role';
