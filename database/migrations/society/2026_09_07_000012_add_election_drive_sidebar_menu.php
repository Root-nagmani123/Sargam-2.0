...
/**
 * Adds "Create Election Drive" alongside "Define Club/ Society" in the
...
{
    private string $route          = 'master/election-drive';
    private string $permissionName = 'create_election_drive';
    private string $menuName       = 'Create Election Drive';
