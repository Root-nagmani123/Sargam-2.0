...
/**
 * Adds "Club/ Society Programme Mapping" alongside "Define Club/ Society" in the
...
{
    private string $route          = 'master/club-society-programme-mapping';
    private string $permissionName = 'club_society_programme_mapping';
    private string $menuName       = 'Club/ Society Programme Mapping';
