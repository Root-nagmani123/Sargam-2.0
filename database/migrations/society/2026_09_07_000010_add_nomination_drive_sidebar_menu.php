...
/**
 * Adds "Create Nomination Drive" alongside "Define Club/ Society" in the
...
{
    private string $route          = 'master/nomination-drive';
    private string $permissionName = 'create_nomination_drive';
    private string $menuName       = 'Create Nomination Drive';
