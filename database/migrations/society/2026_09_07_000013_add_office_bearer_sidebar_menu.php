...
/**
 * Adds "Officer Bearers" alongside "Define Club/ Society" in the
...
{
    private string $route          = 'master/officer-bearers';
    private string $permissionName = 'officer_bearers';
    private string $menuName       = 'Officer Bearers';
