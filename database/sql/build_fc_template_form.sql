...
(@s4,'doc_nps_subscription','National Pension System (NPS) / Unified Pension Scheme (UPS) Subscription Registration Form','file','fc_joining_documents_user_uploads','accounts_nps_registration','nullable|file|mimes:jpeg,jpg,png,pdf|max:5120',0,14,'Accounts Section Related Documents','col-md-6',5120,'jpeg,jpg,png,pdf',1,@now,@now),
